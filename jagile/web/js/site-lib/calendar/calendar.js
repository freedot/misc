...
Calendar.prototype.getStyle = function() {
	...
	str += '.calendar{position:absolute;width:140px!important;width /**/:142px;height:184px!important;height /**/:174px;background-color:'+this.style.bodyBackColor+';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:400000000;}\n';
...
Calendar.prototype.bindDate = function(date){
	...
	_dayElement.onmousedown = Function(this.Obj + ".onClick(this)");
