    ...
    var i = {
        ...
        __extend: function(t, e) {
            ...
            for (var n in e) if (e.hasOwnProperty(n)) {
                var r = Object.getOwnPropertyDescriptor(e, n), o = r.get, a = r.set;
                o || a ? o && a ? Object.defineProperty(t, n, r) : (o && Object.defineProperty(t, n, o), 
        ...
        class: function(e, s, n, r) {
            ...
            a(h, "hasOwnProperty", i.__hasOwnProperty), a(h, "__class", e), a(h, "__super", n), 
            a(h, "__className", s), a(e, "__super", n), a(e, "__className", s), a(e, "__isclass", !0), 
        ...
        imps: function(t, e) {
            function s(t) {
                var e, r;
                if ((e = i.__internals[t]) && (n[t] = !0, r = e.extend)) for (var o = 0; o < r.length; o++) s(r[o].self);
            }
            if (!e) return null;
...
!function(t, e, i) {
    ...
    i.__newvec;
    i.interface("laya.ui.IItem"), i.interface("laya.ui.ISelect"), i.interface("laya.runtime.IMarket"), 
    i.interface("laya.filters.IFilter"), i.interface("laya.display.ILayout"), i.interface("laya.resource.IDispose"), 
    i.interface("laya.runtime.IConchNode"), i.interface("laya.filters.IFilterAction"), 
    i.interface("laya.runtime.ICPlatformClass");
    var o = function() {
        function e() {}
        return n(e, "laya.utils.RunDriver"), e.FILTER_ACTIONS = [], e.pixelRatio = -1, e._charSizeTestDiv = null, 
        e.now = function() {
            return Date.now();
            ...
            if (e.pixelRatio < 0) {
                var t = H.context, i = t.backingStorePixelRatio || t.webkitBackingStorePixelRatio || t.mozBackingStorePixelRatio || t.msBackingStorePixelRatio || t.oBackingStorePixelRatio || t.backingStorePixelRatio || 1;
        ...
        e.addToAtlas = null, e.flashFlushImage = function(t) {}, e.drawToCanvas = function(t, e, i, s, n, r) {
            var o = Nt.create("2D"), a = new F(i, s, o);
        ...
        if (!i._isinit) {
            ...
            i._isinit = !0, H.__init__(), N.__init__(), _.__init__(), i.timer = new J(), i.scaleTimer = new J(), 
            i.loader = new ft(), it.__init__();
            for (var r = 0, a = n.length; r < a; r++) n[r].enable && n[r].enable();
            return p.__init__(), f.__init__(), D.__init__(), G.beginCheck(), i._currentStage = i.stage = new Ft(), 
            i.stage.conchModel && i.stage.conchModel.setRootNode(), i._getUrlPath(), i.render = new B(0, 0), 
            i.stage.size(t, e), O.__init__(), y.__init__(), x.instance.__init__(i.stage, B.canvas), 
            jt.__init__(), k.autoStopMusic = !0, E.__init__(), B.canvas;
        }
    }, i._getUrlPath = function() {
        var t = H.window.location, e = t.pathname;
    ...
    }, i.stage = null, i.timer = null, i.scaleTimer = null, i.loader = null, i.version = "1.7.20.1beta", 
    i.render = null, i._currentStage = null, i._isinit = !1, i.MiniAdpter = {
        ...
        function t() {
            nt.init(!1, !0), i.init(840, 797), i.stage.scaleMode = "noscale", i.stage.screenMode = "none", 
            i.stage.on("resize", this, this.onResize), this.onInit();
        }
        n(t, "App");
        var e = t.prototype;
        return e.onInit = function() {
            ...
            switch (e.action) {
              case "showRankList":
                1 != t.rankType && (xe.I.listData = []), t.rankType = 1, xe.I.updatePaiHang(e.data);
                break;

              case "showWjRankList":
                2 != t.rankType && (xe.I.listData = []), t.rankType = 2, xe.I.updateWjPaiHang(e.data);
                break;
        ...
        }, e.onResize = function() {}, t.openid = "", t.scoreMax = -1, t.wjScore = 0, t.rankType = 1, 
        t;
    }()), h = function() {
        function t() {
            this._events = null;
        ...
        return i.hasListener = function(t) {
            ...
            n.recover()); else {
                for (var r = 0, o = 0, a = n.length; o < a; o++) {
                    var h = n[o];
                    h ? !h || e && h.caller !== e || h.method !== i || s && !h.once || (r++, n[o] = null, 
                    h.recover()) : r++;
                }
        ...
        return e.onMD = function(t, e, i) {
        ...
        }, e.addEvent = function(t, e, i, s, n, r) {
            void 0 === s && (s = !1), void 0 === r && (r = !0), r && this.removeEvent(t, e, i);
            var o = this.evts[t];
            return null == o && (this.evts[t] = o = {
                name: t,
                calls: []
            }), o.calls.push({
                arg: e,
            ...
            var s = this.evts[t];
            if (null != s) for (var n, r = s.calls.length; r--; ) (n = s.calls[r]).arg == e && n.fun == i && s.calls.splice(r, 1);
        }, e.event = function(t, e) {
            var i = this.evts[t];
            if (null != i) for (var s, n = i.calls.length; n--; ) s = i.calls[n], this.params = s.params, 
            this.data = e, s.fun.call(s.arg, this), s.once && (i.calls.splice(n, 1), 0 == i.calls.length && delete this.evts[t]);
        }, t;
    }(), u = function() {
        function t() {}
        return n(t, "Config"), t.WebGLTextCacheCount = 500, t.atlasEnable = !1, t.showCanvasMark = !1, 
        ...
        return s.destroy = function() {
            ...
            if (t) {
                var n = this._one;
                if (this._cmds) {
                    for (s = this._cmds.length, i = 0; i < s; i++) !(n = this._cmds[i]) || n.callee !== B._context._drawTexture && n.callee !== B._context._drawTextureWithTransform || (n[0] = null, 
                    e._cache.push(n));
                    this._cmds.length = 0;
                } else n && (!n || n.callee !== B._context._drawTexture && n.callee !== B._context._drawTextureWithTransform || (n[0] = null, 
                e._cache.push(n)));
            ...
            var h = !B.isWebGL && (H.onFirefox || H.onEdge || H.onIE || H.onSafari) ? .5 : 0, l = n / t.sourceWidth, c = r / t.sourceHeight;
            if (n = t.width * l, r = t.height * c, t.loaded && (n <= 0 || r <= 0)) return null;
            i += t.offsetX * l, s += t.offsetY * c, this._sp && (this._sp._renderType |= 512);
            var u;
            return i -= h, s -= h, n += 2 * h, r += 2 * h, e._cache.length ? ((u = e._cache.pop())[0] = t, 
            u[1] = i, u[2] = s, u[3] = n, u[4] = r, u[5] = o, u[6] = a) : u = [ t, i, s, n, r, o, a ], 
            u.callee = o || 1 != a ? B._context._drawTextureWithTransform : B._context._drawTexture, 
            ...
            if (this._one && this._render === this._renderOneImg) {
                ...
                var r = s / t.sourceWidth, o = n / t.sourceHeight;
                s = t.width * r, n = t.height * o, e += t.offsetX * r, i += t.offsetY * o, this._one[0] = t, 
                this._one[1] = e, this._one[2] = i, this._one[3] = s, this._one[4] = n, this._repaint();
            ...
            for (var _ = 2, d = 0; d < o; d++) {
                var f = r * Math.cos(u) + s, p = r * Math.sin(u) + n;
            ...
            void 0 === r && (r = 1);
            var o = 0;
            B.isWebGL && (o = et.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), 
            this._vectorgraphArray.push(o));
            var a = r % 2 == 0 ? 0 : .5, h = [ t + a, e + a, i + a, s + a, n, r, o ];
            this._saveToCmd(B._context._drawLine, h);
        }, s.drawLines = function(t, e, i, s, n) {
            void 0 === n && (n = 1);
            var r = 0;
            if (i && !(i.length < 4)) {
                B.isWebGL && (r = et.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), 
                this._vectorgraphArray.push(r));
                var o = n % 2 == 0 ? 0 : .5, a = [ t + o, e + o, i, s, n, r ];
            ...
            void 0 === o && (o = 1);
            var a = r ? o / 2 : 0, h = r ? o : 0, l = [ t + a, e + a, i - h, s - h, n, r, o ];
            this._saveToCmd(B._context._drawRect, l);
        }, s.drawCircle = function(t, e, i, s, n, r) {
            void 0 === r && (r = 1);
            var o = n ? r / 2 : 0, a = 0;
            B.isWebGL && (a = et.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), 
            ...
            B.isWebGL && (c = et.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), 
            ...
            var h = n ? r % 2 == 0 ? 0 : .5 : 0, l = [ t + h, e + h, i, s, n, r, o, a ];
            ...
            if (B.isConchNode) {
                ...
                t._saveToCmd = null, e.drawImageS && (t.drawTextures = function(t, e) {
                    ...
                    void 0 === o && (o = 1), t) if (t.loaded) {
                        ...
                        o = o < 0 ? 0 : o > 1 ? 1 : o, s = s - t.sourceWidth + t.width, n = n - t.sourceHeight + t.height, 
                        !(s <= 0 || n <= 0))) {
                            e += t.offsetX, i += t.offsetY;
                            var a = t.uv, h = t.bitmap.width, l = t.bitmap.height;
                            a[4] < a[0] && a[5] < a[1] ? this.drawImageM(t.bitmap.source, a[4] * h, a[5] * l, (a[0] - a[4]) * h, (a[1] - a[5]) * l, e, i, s, n, r, o) : this.drawImageM(t.bitmap.source, a[0] * h, a[1] * l, (a[2] - a[0]) * h, (a[5] - a[3]) * l, e, i, s, n, r, o), 
                            this._repaint();
                        }
                    ...
                    if (void 0 === s && (s = 0), void 0 === n && (n = 0), void 0 === r && (r = "repeat"), 
                    t && t.loaded) {
                        var a, h = B._context.ctx, l = t.bitmap.width, c = t.bitmap.height, u = t.uv;
        ...
        return e.loadFont = function(t, e) {
            ...
            this.parseFont(xt.getRes(this._path), xt.getRes(this._path.replace(".fnt", ".png"))), 
            ...
            if (null != t && null != e) {
                ...
                for (r = 0; r < n.length; r++) {
                    var o = n[r], a = parseInt(o.getAttributeNode("id").nodeValue), h = parseInt(o.getAttributeNode("xoffset").nodeValue) / 1, l = parseInt(o.getAttributeNode("yoffset").nodeValue) / 1, c = parseInt(o.getAttributeNode("xadvance").nodeValue) / 1, u = new L();
            ...
            if (null != t && null != e) {
                ...
                for (r = 0; r < n.length; r++) {
                    var o = n[r].attributes, a = parseInt(o.id.nodeValue), h = parseInt(o.xoffset.nodeValue) / 1, l = parseInt(o.yoffset.nodeValue) / 1, c = parseInt(o.xadvance.nodeValue) / 1, u = new L();
            ...
            for (var l = 0, c = 0, u = t.length; c < u; c++) (o = this.getCharTexture(t.charAt(c))) && (e.graphics.drawTexture(o, i + l + h, s), 
        ...
        function t(e) {
            ...
            this._color = U.create(t.defaultColor), this.family = t.defaultFamily, this.stroke = t._STROKE, 
        ...
        return e.destroy = function() {
            ...
            return void 0 === t && (t = !1), (!this._bounds || !this._temp || this._temp.length < 1 || t != this._cacheBoundsType) && (this._bounds = L._getWrapRec(this.getBoundPoints(t), this._bounds)), 
            ...
            this._cacheBoundsType = t, this._rstBoundPoints = tt.copyArray(this._rstBoundPoints, this._temp);
        }, e._getCmdPoints = function(e) {
            void 0 === e && (e = !1);
            var i, s = B._context, n = this._graphics.cmds;
            ...
            var o = t._initMatrix;
            o.identity();
            for (var a, h, l = t._tempMatrix, c = NaN, u = NaN, _ = NaN, d = NaN, f = NaN, p = NaN, g = 0, m = n.length; g < m; g++) if ((a = n[g]).callee) switch (a.callee) {
              case s._save:
              case 7:
                r.push(o), o = o.clone();
                break;
              ...
              case s._drawTexture:
                h = a[0], e ? a[3] && a[4] ? t._addPointArrToRst(i, L._getBoundPointS(a[1], a[2], a[3], a[4]), o) : (h = a[0], 
                t._addPointArrToRst(i, L._getBoundPointS(a[1], a[2], h.width, h.height), o)) : (c = (a[3] || h.sourceWidth) / h.width, 
                ...
                t._addPointArrToRst(i, L._getBoundPointS(a[1] - f, a[2] - p, _, d), o));
                break;

              case s._fillTexture:
                a[3] && a[4] ? t._addPointArrToRst(i, L._getBoundPointS(a[1], a[2], a[3], a[4]), o) : (h = a[0], 
                t._addPointArrToRst(i, L._getBoundPointS(a[1], a[2], h.width, h.height), o));
                break;

              case s._drawTextureWithTransform:
                var v;
                a[5] ? (o.copyTo(l), l.concat(a[5]), v = l) : v = o, e ? a[3] && a[4] ? t._addPointArrToRst(i, L._getBoundPointS(a[1], a[2], a[3], a[4]), v) : (h = a[0], 
                t._addPointArrToRst(i, L._getBoundPointS(a[1], a[2], h.width, h.height), v)) : (h = a[0], 
                c = (a[3] || h.sourceWidth) / h.width, u = (a[4] || h.sourceHeight) / h.height, 
                _ = c * h.sourceWidth, d = u * h.sourceHeight, f = h.offsetX > 0 ? h.offsetX : 0, 
                p = h.offsetY > 0 ? h.offsetY : 0, f *= c, p *= u, t._addPointArrToRst(i, L._getBoundPointS(a[1] - f, a[2] - p, _, d), v));
                break;
            ...
            return i.length > 200 ? i = tt.copyArray(i, L._getWrapRec(i)._getBoundPoints()) : i.length > 8 && (i = T.scanPList(i)), 
            i;
            ...
            var a = (r - n) % (2 * Math.PI) / 10, h = NaN, l = n;
        ...
        return n(t, "laya.events.KeyBoardManager"), t.__init__ = function() {
            ...
            if (t.enabled) {
                ...
                for (var n = i.stage.focus && null != i.stage.focus.event && i.stage.focus.displayedInStage ? i.stage.focus : i.stage, r = n; r; ) r.event(s, t._event.setTo(s, r, n)), 
                r = r.parent;
            }
        ...
        function t() {
            ...
            this._tTouchID = 0, this._event = new v(), this._matrix = new I(), this._point = new P(), 
            this._rect = new L(), this._prePoint = new P(), this._curTouchID = NaN;
        }
        ...
        return e.__init__ = function(e, i) {
            ...
            i.oncontextmenu = function(e) {
                ...
                t.enabled && (r.push(e), t._isFirstTouch || jt.isInputting || e.preventDefault(), 
                n.mouseDownTime = H.now());
            }), i.addEventListener("touchend", function(e) {
                t.enabled ? (t._isFirstTouch || jt.isInputting || e.preventDefault(), t._isFirstTouch = !1, 
                r.push(e), n.mouseDownTime = -H.now()) : s._curTouchID = NaN;
            ...
            return a ? (this._target = t, s.call(this, t)) : s === this.onMouseUp && t === this._stage && (this._target = this._stage, 
            s.call(this, this._target)), a;
                ...
                for (var i, s = 0, n = 0, r = 0; s < e; ) {
                    ...
                    o.type) {
                      ...
                      case "touchcancel":
                        ...
                        for (n = 0, r = h.length; n < r; n++) if (i = h[n], t.multiTouchEnabled || i.identifier == this._curTouchID) {
                      ...
                      case "touchmove":
                        ...
                        for (n = 0, r = l.length; n < r; n++) i = l[n], (t.multiTouchEnabled || i.identifier == this._curTouchID) && (this.initEvent(i, o), 
        ...
        function t() {
            ...
            this._lastClickTime = 0, this._event = new v();
        }
        ...
        return e._clearTempArrs = function() {
            ...
            if (void 0 === s && (s = !1), this.enable) {
                var n, r, o;
                n = this.getTouchFromArr(i, this.preOvers), o = this.getEles(e, null, t._tEleArr), 
                n ? n.tar = e : (r = this.createTouchO(e, i), this.preOvers.push(r)), H.onMobile && this.sendEvents(o, "mouseover", i);
                var a;
                a = s ? this.preDowns : this.preRightDowns, (n = this.getTouchFromArr(i, a)) ? n.tar = e : (r = this.createTouchO(e, i), 
                a.push(r)), this.sendEvents(o, s ? "mousedown" : "rightmousedown", i), this._clearTempArrs();
            }
            ...
            if (void 0 === s && (s = !1), this.enable) {
                var n, r, o, a, h, l = 0, c = 0, u = H.onMobile;
                ...
                if (_ = s ? this.preDowns : this.preRightDowns, n = this.getTouchFromArr(i, _)) {
                    var d = !1, f = H.now();
                    if (d = f - this._lastClickTime < 300, this._lastClickTime = f, e == n.tar) h = r; else for (o = this.getEles(n.tar, null, t._oldArr), 
                    ...
                    this.removeTouchFromArr(i, _), n.tar = null, q.recover("TouchData", n);
                } else ;
                (n = this.getTouchFromArr(i, this.preOvers)) && u && ((h = this.getEles(n.tar, null, h)) && h.length > 0 && this.sendEvents(h, "mouseout", i), 
                this.removeTouchFromArr(i, this.preOvers), n.tar = null, q.recover("TouchData", n)), 
                this._clearTempArrs();
            }
        ...
        return i.imps(e, {
            ...
            for (var s, n = e.getImageData(0, 0, i.width, i.height), r = n.data, o = 0, a = r.length; o < a; o += 4) s = this.getColor(r[o], r[o + 1], r[o + 2], r[o + 3]), 
            0 != r[o + 3] && (r[o] = s[0], r[o + 1] = s[1], r[o + 2] = s[2], r[o + 3] = s[3]);
            return e.putImageData(n, 0, 0), t;
        }, e.getColor = function(t, e, i, s) {
            var n = [];
            if (this.data._mat && this.data._alpha) {
                var r = this.data._mat, o = this.data._alpha;
                n[0] = r[0] * t + r[1] * e + r[2] * i + r[3] * s + o[0], n[1] = r[4] * t + r[5] * e + r[6] * i + r[7] * s + o[1], 
                n[2] = r[8] * t + r[9] * e + r[10] * i + r[11] * s + o[2], n[3] = r[12] * t + r[13] * e + r[14] * i + r[15] * s + o[3];
            }
            return n;
        }, t;
    }(), S = function() {
        ...
        return e._switchPoint = function(t, e) {
            ...
            var i = this._controlPoints[0], s = this._controlPoints[1], n = this._controlPoints[2], r = Math.pow(1 - t, 2) * i.x + 2 * t * (1 - t) * s.x + Math.pow(t, 2) * n.x, o = Math.pow(1 - t, 2) * i.y + 2 * t * (1 - t) * s.y + Math.pow(t, 2) * n.y;
            e.push(r, o);
        }, e.getPoint3 = function(t, e) {
            var i = this._controlPoints[0], s = this._controlPoints[1], n = this._controlPoints[2], r = this._controlPoints[3], o = Math.pow(1 - t, 3) * i.x + 3 * s.x * t * (1 - t) * (1 - t) + 3 * n.x * t * t * (1 - t) + r.x * Math.pow(t, 3), a = Math.pow(1 - t, 3) * i.y + 3 * s.y * t * (1 - t) * (1 - t) + 3 * n.y * t * t * (1 - t) + r.y * Math.pow(t, 3);
            e.push(o, a);
        ...
        return n(t, "laya.maths.GrahamScan"), t.multiply = function(t, e, i) {
            ...
            var i, s, n, r = 0, o = 0, a = 0, h = e.length, l = {};
        ...
        return n(t, "laya.maths.MathUtil"), t.subtractVector3 = function(t, e, i) {
            ...
            var n = t[0], r = t[1], o = t[2], a = t[3];
            s[0] = n + i * (e[0] - n), s[1] = r + i * (e[1] - r), s[2] = o + i * (e[2] - o), 
            s[3] = a + i * (e[3] - a);
        }, t.slerpQuaternionArray = function(t, e, i, s, n, r, o) {
            var a, h, l, c, u, _ = t[e + 0], d = t[e + 1], f = t[e + 2], p = t[e + 3], g = i[s + 0], m = i[s + 1], v = i[s + 2], y = i[s + 3];
            return (h = _ * g + d * m + f * v + p * y) < 0 && (h = -h, g = -g, m = -m, v = -v, 
            y = -y), 1 - h > 1e-6 ? (a = Math.acos(h), l = Math.sin(a), c = Math.sin((1 - n) * a) / l, 
            u = Math.sin(n * a) / l) : (c = 1 - n, u = n), r[o + 0] = c * _ + u * g, r[o + 1] = c * d + u * m, 
        ...
        return e.identity = function() {
            ...
            var e = this.a, i = this.b, s = this.c, n = this.d, r = this.tx, o = e * n - i * s, a = n / o, h = -i / o, l = -s / o, c = e / o, u = (s * this.ty - n * r) / o, _ = -(e * this.ty - i * r) / o;
            ...
            var e = Math.cos(t), i = Math.sin(t), s = this.a, n = this.b, r = this.c, o = this.d;
            0 !== n || 0 !== r ? (this.a = e * s + i * r, this.b = e * n + i * o, this.c = -i * s + e * r, 
            this.d = -i * n + e * o) : (this.a = e * s, this.b = i * o, this.c = -i * s, this.d = e * o), 
            this.bTransform = !0;
        }, e.clone = function() {
            var e = t.create();
            ...
            var s = t.a, n = t.b, r = t.c, o = t.d, a = t.tx, h = t.ty, l = e.a, c = e.b, u = e.c, _ = e.d, d = e.tx, f = e.ty;
            return 0 !== c || 0 !== u ? (i.a = s * l + n * u, i.b = s * c + n * _, i.c = r * l + o * u, 
            i.d = r * c + o * _, i.tx = l * a + u * h + d, i.ty = c * a + _ * h + f) : (i.a = s * l, 
            i.b = n * _, i.c = r * l, i.d = o * _, i.tx = l * a + d, i.ty = _ * h + f), i;
        }, t.mul16 = function(t, e, i) {
            var s = t.a, n = t.b, r = t.c, o = t.d, a = t.tx, h = t.ty, l = e.a, c = e.b, u = e.c, _ = e.d, d = e.tx, f = e.ty;
            return 0 !== c || 0 !== u ? (i[0] = s * l + n * u, i[1] = s * c + n * _, i[4] = r * l + o * u, 
            i[5] = r * c + o * _, i[12] = l * a + u * h + d, i[13] = c * a + _ * h + f) : (i[0] = s * l, 
            i[1] = n * _, i[4] = r * l, i[5] = o * _, i[12] = l * a + d, i[13] = _ * h + f), 
            i;
        }, t.mulPre = function(t, e, i, s, n, r, o, a) {
            var h = t.a, l = t.b, c = t.c, u = t.d, _ = t.tx, d = t.ty;
            return 0 !== i || 0 !== s ? (a.a = h * e + l * s, a.b = h * i + l * n, a.c = c * e + u * s, 
            a.d = c * i + u * n, a.tx = e * _ + s * d + r, a.ty = i * _ + n * d + o) : (a.a = h * e, 
            a.b = l * n, a.c = c * e, a.d = u * n, a.tx = e * _ + r, a.ty = n * d + o), a;
        }, t.mulPos = function(t, e, i, s, n, r, o, a) {
            var h = t.a, l = t.b, c = t.c, u = t.d, _ = t.tx, d = t.ty;
            return 0 !== l || 0 !== c ? (a.a = e * h + i * c, a.b = e * l + i * u, a.c = s * h + n * c, 
            a.d = s * l + n * u, a.tx = h * r + c * o + _, a.ty = l * r + u * o + d) : (a.a = e * h, 
            a.b = i * u, a.c = s * h, a.d = n * u, a.tx = h * r + _, a.ty = u * o + d), a;
        }, t.preMul = function(t, e, i) {
            var s = t.a, n = t.b, r = t.c, o = t.d, a = e.a, h = e.b, l = e.c, c = e.d, u = e.tx, _ = e.ty;
            return i.a = a * s, i.b = i.c = 0, i.d = c * o, i.tx = u * s + t.tx, i.ty = _ * o + t.ty, 
            0 === h && 0 === l && 0 === n && 0 === r || (i.a += h * r, i.d += l * n, i.b += a * n + h * o, 
            i.c += l * s + c * r, i.tx += _ * r, i.ty += u * n), i;
        }, t.preMulXY = function(t, e, i, s) {
            var n = t.a, r = t.b, o = t.c, a = t.d;
            return s.a = n, s.b = r, s.c = o, s.d = a, s.tx = e * n + t.tx + i * o, s.ty = i * a + t.ty + e * r, 
            s;
        }, t.create = function() {
        ...
        return e.setTo = function(t, e, i, s) {
            ...
            i = i || new t();
            var s, n, r, o, a, h = e.length, l = P.TEMP;
            for (r = a = -(n = o = 99999), s = 0; s < h; s += 2) l.x = e[s], l.y = e[s + 1], 
            n = n < l.x ? n : l.x, o = o < l.y ? o : l.y, r = r > l.x ? r : l.x, a = a > l.y ? a : l.y;
        ...
        return n(t, "laya.media.SoundManager"), r(1, t, "useAudioMusic", function() {
            ...
            var h;
            H.onMiniGame || (h = i.loader.getRes(e)), r || (r = t._soundClass), h || ((h = new r()).load(e), 
            H.onMiniGame || xt.cacheRes(e, h));
            var l;
            return (l = h.play(o, s)) ? (l.url = e, l.volume = e == t._tMusic ? t.musicVolume : t.soundVolume, 
            l.completeHandler = n, l) : null;
        }, t.destroySound = function(t) {
            var e = i.loader.getRes(t);
            e && (xt.clearRes(t), e.dispose());
        }, t.playMusic = function(e, i, s, n) {
            return void 0 === i && (i = 0), void 0 === n && (n = 0), e = R.formatURL(e), t._tMusic = e, 
        ...
        return e.load = function(t) {
            ...
            this._http = new yt(), this._http.on("error", this, this._onErr), this._http.on("complete", this, this._onHttpLoaded), 
            ...
            var t = this, e = H.createElement("style");
            e.type = "text/css", H.document.body.appendChild(e), e.textContent = "@font-face { font-family:'" + this.fontName + "'; src:url('" + this._url + "');}", 
        ...
        function e(t, s) {
            ...
            e._mainCanvas.source.width = t, e._mainCanvas.source.height = s, o && e.WebGL.init(e._mainCanvas, t, s), 
            H.container.appendChild(e._mainCanvas.source), (e._context = new F(t, s, o ? null : e._mainCanvas)).ctx.setIsMainContext(), 
            H.window.requestAnimationFrame(n), i.stage.on("visibilitychange", this, this._onVisibilitychange);
        }
        ...
        function t(e, i, s) {
            this.x = 0, this.y = 0, this._drawTexture = function(t, e, i) {
                ...
                var s = this.ctx;
                B.isWebGL && s.setPathId(i[8]), s.beginPath(), B.isWebGL ? (s.movePath(i[0] + t, i[1] + e), 
                ...
                var n = this.ctx;
                B.isWebGL && n.setPathId(s[6]), Z.drawCall++, n.beginPath(), B.isWebGL && n.movePath(s[0] + e, s[1] + i), 
                ...
                var s = this.ctx;
                B.isWebGL && s.setPathId(i[6]), s.beginPath(), s.strokeStyle = i[4], s.lineWidth = i[5], 
                B.isWebGL ? (s.movePath(t, e), s.moveTo(i[0], i[1]), s.lineTo(i[2], i[3])) : (s.moveTo(t + i[0], e + i[1]), 
                s.lineTo(t + i[2], e + i[3])), s.stroke();
            }, this._drawLines = function(t, e, i) {
                var s = this.ctx;
                B.isWebGL && s.setPathId(i[5]), s.beginPath(), t += i[0], e += i[1], B.isWebGL && s.movePath(t, e), 
                s.strokeStyle = i[3], s.lineWidth = i[4];
                var n = i[2], r = 2, o = n.length;
                if (B.isWebGL) for (s.moveTo(n[0], n[1]); r < o; ) s.lineTo(n[r++], n[r++]); else for (s.moveTo(t + n[0], e + n[1]); r < o; ) s.lineTo(t + n[r++], e + n[r++]);
                s.stroke();
                ...
                var s = this.ctx, n = i[2], r = 2, o = n.length;
                if (B.isWebGL) for (s.setPathId(i[6]), s.beginPath(), t += i[0], e += i[1], s.movePath(t, e), 
                s.moveTo(n[0], n[1]); r < o; ) s.lineTo(n[r++], n[r++]); else for (s.beginPath(), 
                t += i[0], e += i[1], s.moveTo(t + n[0], e + n[1]); r < o; ) s.lineTo(t + n[r++], e + n[r++]);
            ...
            }, s ? this.ctx = s.getContext("2d") : (s = Nt.create("3D"), this.ctx = o.createWebGLContext2D(s), 
        ...
        return e.destroy = function() {
            ...
            void 0 === s && (s = !1);
            var n = this.ctx;
            null != t && (n.fillStyle = t, B.isWebGL ? n.fill(s) : n.fill()), null != e && i > 0 && (n.strokeStyle = e, 
            ...
            var o = this.ctx;
            o.beginPath(), o.strokeStyle = n, o.lineWidth = r, o.arc(e + this.x, i + this.y, s, 0, t.PI2), 
            o.stroke();
        }, e.drawTriangles = function(t, e, i) {
            if (B.isWebGL) this.ctx.drawTriangles(i[0], t + i[1], e + i[2], i[3], i[4], i[5], i[6], i[7], i[8], i[9]); else {
                var s = i[5], n = 0, r = s.length, o = this.ctx;
                for (n = 0; n < r; n += 3) {
                    var a = 2 * s[n], h = 2 * s[n + 1], l = 2 * s[n + 2];
            ...
            void 0 === r && (r = 1);
            var o = this.ctx;
            o.beginPath(), o.strokeStyle = n, o.lineWidth = r, o.moveTo(this.x + t, this.y + e), 
            o.lineTo(this.x + i, this.y + s), o.stroke();
        }, e.clear = function() {
            this.ctx.clear();
        ...
        return e.onCreate = function(t) {}, e._style = function(t, e, i, s) {
            ...
            if (r != t.NORENDER) {
                ...
                i.ctx.save(), i.ctx.clipRect(s, n, o.width, o.height), r._fun.call(r, e, i, s - o.x, n - o.y), 
                i.ctx.restore();
            }
            ...
            r && o != t.NORENDER ? (i.save(), i.transform(r.a, r.b, r.c, r.d, r.tx + s, r.ty + n), 
            o._fun.call(o, e, i, 0, 0), i.restore()) : o._fun.call(o, e, i, s, n);
            ...
            if (r) {
                ...
                if ("bitmap" === d ? Z.canvasBitmap++ : Z.canvasNormal++, _) {
                    ...
                    var f, p;
                    B.isWebGL && "bitmap" !== d ? r._cacheRec.setTo(-t.pivotX, -t.pivotY, 1, 1) : ((c = t.getSelfBounds()).x = c.x - t.pivotX, 
                    c.y = c.y - t.pivotY, c.x = c.x - 16, c.y = c.y - 16, c.width = c.width + 32, c.height = c.height + 32, 
                    c.x = Math.floor(c.x + s) - s, c.y = Math.floor(c.y + n) - n, c.width = Math.floor(c.width), 
                    c.height = Math.floor(c.height), r._cacheRec.copyFrom(c)), c = r._cacheRec;
                    var g = B.isWebGL ? 1 : H.pixelRatio * i.stage.clientScaleX, m = B.isWebGL ? 1 : H.pixelRatio * i.stage.clientScaleY;
                    if (!B.isWebGL) {
                        var v, y = 1, x = 1;
                    ...
                    if (f = c.width * g, p = c.height * m, h = c.x, l = c.y, B.isWebGL && "bitmap" === d && (f > 2048 || p > 2048)) return console.warn("cache bitmap size larger than 2048,cache ignored"), 
                    r.ctx && (q.recover("RenderContext", r.ctx), r.ctx.canvas.size(0, 0), r.ctx = null), 
                    void o._fun.call(o, t, e, s, n);
                    u || (u = r.ctx = q.getItem("RenderContext") || new F(f, p, Nt.create("AUTO"))), 
                    ...
                    if (1 != g || 1 != m) {
                        var C = u.ctx;
                        C.save(), C.scale(g, m), !B.isConchWebGL && B.isConchApp && (b = t._$P.cf) && C.setFilterMatrix && C.setFilterMatrix(b._mat, b._alpha), 
                        o._fun.call(o, t, u, -h, -l), C.restore(), B.isConchApp && !B.isConchWebGL || t._applyFilters();
                    } else C = u.ctx, !B.isConchWebGL && B.isConchApp && (b = t._$P.cf) && C.setFilterMatrix && C.setFilterMatrix(b._mat, b._alpha), 
                    o._fun.call(o, t, u, -h, -l), B.isConchApp && !B.isConchWebGL || t._applyFilters();
        ...
        return e.replaceReset = function() {
            ...
            Z.drawCall++, arguments.length > 3 && null != s && (this.font = s, this.fillStyle = n, 
            this.textAlign = r, this.textBaseline = "top"), this.__fillText(t, e, i);
        }, e.fillBorderText = function(t, e, i, s, n, r, o, a) {
            Z.drawCall++, this.font = s, this.fillStyle = n, this.textBaseline = "top", this.strokeStyle = r, 
            this.lineWidth = o, this.textAlign = a, this.__strokeText(t, e, i), this.__fillText(t, e, i);
        }, e.strokeText = function(t, e, i, s, n, r, o) {
            Z.drawCall++, arguments.length > 3 && null != s && (this.font = s, this.strokeStyle = n, 
            ...
            this.drawImage(t.source, l[0] * c, l[1] * u, (l[2] - l[0]) * c, (l[5] - l[3]) * u, e, i, s, n)) : this.drawImage(t.source, l[0] * c, l[1] * u, (l[2] - l[0]) * c, (l[5] - l[3]) * u, e + o, i + a, s, n), 
            this.restore();
            ...
            if (h.loaded && h.bitmap && h.source) {
                ...
                n ? (this.save(), this.transform(n.a, n.b, n.c, n.d, n.tx + t, n.ty + e), this.drawImage(h.source, u[0] * _, u[1] * d, (u[2] - u[0]) * _, (u[5] - u[3]) * d, a[1] - i, a[2] - s, a[3], a[4]), 
                this.restore()) : this.drawImage(h.source, u[0] * _, u[1] * d, (u[2] - u[0]) * _, (u[5] - u[3]) * d, a[1] - i + t, a[2] - s + e, a[3], a[4]), 
            ...
            this.translate(l, c), this.fillRect(u, _, s, n, a.pat), this.translate(-l, -c);
        }, e.drawTriangle = function(t, e, i, s, n, r, o, a) {
            var h = t.bitmap, l = h.source, c = t.width, u = t.height, _ = h.width, d = h.height, f = i[s] * _, p = i[n] * _, g = i[r] * _, m = i[s + 1] * d, v = i[n + 1] * d, y = i[r + 1] * d, x = e[s], w = e[n], b = e[r], C = e[s + 1], S = e[n + 1], T = e[r + 1];
            if (a) {
                var M = (x + w + b) / 3, I = (C + S + T) / 3, P = x - M, L = C - I, k = Math.sqrt(P * P + L * L);
                x = M + P / k * (k + 1), C = I + L / k * (k + 1), L = S - I, w = M + (P = w - M) / (k = Math.sqrt(P * P + L * L)) * (k + 1), 
                S = I + L / k * (k + 1), L = T - I, b = M + (P = b - M) / (k = Math.sqrt(P * P + L * L)) * (k + 1), 
                T = I + L / k * (k + 1);
            }
            this.save(), o && this.transform(o.a, o.b, o.c, o.d, o.tx, o.ty), this.beginPath(), 
            this.moveTo(x, C), this.lineTo(w, S), this.lineTo(b, T), this.closePath(), this.clip();
            var E = 1 / (f * v + m * g + p * y - v * g - m * p - f * y), A = x * v + m * b + w * y - v * b - m * w - x * y, R = f * w + x * g + p * b - w * g - x * p - f * b, B = f * v * b + m * w * g + x * p * y - x * v * g - m * p * b - f * w * y, F = C * v + m * T + S * y - v * T - m * S - C * y, O = f * S + C * g + p * T - S * g - C * p - f * T, N = f * v * T + m * S * g + C * p * y - C * v * g - m * p * T - f * S * y;
            this.transform(A * E, F * E, R * E, O * E, B * E, N * E), this.drawImage(l, t.uv[0] * _, t.uv[1] * d, c, u, t.uv[0] * _, t.uv[1] * d, c, u), 
            this.restore();
        }, e.flush = function() {
            return 0;
        }, e.fillWords = function(t, e, i, s, n, r) {
            ...
            for (var o = 0, a = t.length; o < a; o++) {
                ...
                if (this.__fillText(h.char, h.x + e, h.y + i), 1 === r) {
                    ...
                    c || (c = 0), this.beginPath(), this.strokeStyle = n, this.lineWidth = 1, this.moveTo(e + h.x - c + .5, i + h.y + l + .5), 
                    this.lineTo(e + h.x + h.width + c + .5, i + h.y + l + .5), this.stroke();
                }
            }
        }, e.fillBorderWords = function(t, e, i, s, n, r, o) {
            s && (this.font = s), n && (this.fillStyle = n), this.textBaseline = "top", this.lineWidth = o, 
        ...
        return n(t, "laya.ui.UIUtils"), t.fillArray = function(t, e, i) {
            var s = t.concat();
            if (e) for (var n = e.split(","), r = 0, o = Math.min(s.length, n.length); r < o; r++) {
                var a = n[r];
        ...
        return n(s, "laya.utils.Browser"), r(1, s, "pixelRatio", function() {
            ...
            return s.__init__(), s._container || ((s._container = s.createElement("div")).id = "layaContainer", 
            s.document.body.appendChild(s._container)), s._container;
        }, function(t) {
            s._container = t;
            ...
            if (!s._window) {
                ...
                s.userAgent = s.window.navigator.userAgent, s.onIOS = !!(s.u = s.userAgent).match(/\(i[^;]+;(U;)? CPU.+Mac OS X/), 
                s.onMobile = s.u.indexOf("Mobile") > -1, s.onIPhone = s.u.indexOf("iPhone") > -1, 
                s.onMac = s.u.indexOf("Mac OS X") > -1, s.onIPad = s.u.indexOf("iPad") > -1, s.onAndroid = s.u.indexOf("Android") > -1 || s.u.indexOf("Adr") > -1, 
                s.onWP = s.u.indexOf("Windows Phone") > -1, s.onQQBrowser = s.u.indexOf("QQBrowser") > -1, 
                s.onMQQBrowser = s.u.indexOf("MQQBrowser") > -1 || s.u.indexOf("Mobile") > -1 && s.u.indexOf("QQ") > -1, 
                s.onIE = !!s.window.ActiveXObject || "ActiveXObject" in s.window, s.onWeiXin = s.u.indexOf("MicroMessenger") > -1, 
                s.onPC = !s.onMobile, s.onSafari = s.u.indexOf("Safari") > -1, s.onFirefox = s.u.indexOf("Firefox") > -1, 
                s.onEdge = s.u.indexOf("Edge") > -1, s.onMiniGame = s.u.indexOf("MiniGame") > -1, 
                s.onLimixiu = s.u.indexOf("limixiu") > -1, s.httpProtocol = "http:" == s.window.location.protocol, 
                ...
                s.soundType = s.webAudioEnabled ? "WEBAUDIOSOUND" : "AUDIOSOUND", mt = s.webAudioEnabled ? vt : pt, 
                s.webAudioEnabled && vt.initWebAudio(), pt._initMusicAudio(), s.enableTouch = "ontouchstart" in t || t.DocumentTouch && e instanceof DocumentTouch, 
                t.focus(), k._soundClass = mt, k._musicClass = pt, B._mainCanvas = B._mainCanvas || Nt.create("2D"), 
                s.canvas || (s.canvas = Nt.create("2D"), s.context = s.canvas.getContext("2d"));
            }
        }, s._onMessage = function(t) {
            if (t.data && "size" == t.data.name) {
                if (s.window.innerWidth = t.data.width, s.window.innerHeight = t.data.height, s.window.__innerHeight = t.data.clientHeight, 
                !s.document.createEvent) return void console.warn("no document.createEvent");
            ...
            return o.now();
        }, s._window = null, s._document = null, s._container = null, s.userAgent = null, 
        s.u = null, s.onIOS = !1, s.onMac = !1, s.onMobile = !1, s.onIPhone = !1, s.onIPad = !1, 
        s.onAndroid = !1, s.onWP = !1, s.onQQBrowser = !1, s.onMQQBrowser = !1, s.onSafari = !1, 
        s.onFirefox = !1, s.onEdge = !1, s.onIE = !1, s.onWeiXin = !1, s.onMiniGame = !1, 
        s.onLimixiu = !1, s.onPC = !1, s.httpProtocol = !1, s.webAudioEnabled = !1, s.soundType = null, 
        s.enableTouch = !1, s.canvas = null, s.context = null, s.__init$ = function() {}, 
        s;
    }(), G = function() {
        function t() {}
        ...
        return n(t, "laya.utils.ClassUtils"), t.regClass = function(e, i) {
            ...
            return 1 == s && 1 == n && 0 == r || ((i = i || new I()).scale(s, n), i.rotate(.0174532922222222 * r)), 
            i;
        ...
        return e.start = function(t, e, s, n, r, o, a, h) {
            ...
            this.elasticDistance = e ? n : 0, this.elasticBackTime = r, this.data = o, this._disableMouseEvent = a, 
            ...
            this._dragging && (x.instance.disableMouseEvent = !1, i.stage.off("mouseup", this, this.onStageMouseUp), 
            ...
            if (this._clickOnly) {
                ...
                this.target.event("dragstart", this.data), x.instance.disableMouseEvent = this._disableMouseEvent, 
            ...
            if (x.instance.disableMouseEvent = !1, i.stage.off("mouseup", this, this.onStageMouseUp), 
        ...
        return n(t, "laya.utils.Ease"), t.linearNone = function(t, e, i, s) {
            ...
            var a;
            return 0 == e ? i : 1 == (e /= n) ? i + s : (o || (o = .3 * n), !r || s > 0 && r < s || s < 0 && r < -s ? (r = s, 
            a = o / 4) : a = o / t.PI2 * Math.asin(s / r), -r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * n - a) * t.PI2 / o) + i);
        }, t.elasticInOut = function(e, i, s, n, r, o) {
            void 0 === r && (r = 0), void 0 === o && (o = 0);
            var a;
            return 0 == e ? i : 2 == (e /= .5 * n) ? i + s : (o || (o = n * (.3 * 1.5)), !r || s > 0 && r < s || s < 0 && r < -s ? (r = s, 
            a = o / 4) : a = o / t.PI2 * Math.asin(s / r), e < 1 ? r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * n - a) * t.PI2 / o) * -.5 + i : r * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * n - a) * t.PI2 / o) * .5 + s + i);
        }, t.elasticOut = function(e, i, s, n, r, o) {
            void 0 === r && (r = 0), void 0 === o && (o = 0);
            var a;
            return 0 == e ? i : 1 == (e /= n) ? i + s : (o || (o = .3 * n), !r || s > 0 && r < s || s < 0 && r < -s ? (r = s, 
            a = o / 4) : a = o / t.PI2 * Math.asin(s / r), r * Math.pow(2, -10 * e) * Math.sin((e * n - a) * t.PI2 / o) + s + i);
        ...
        return e.isHit = function(e, i) {
            ...
            c = s.length;
            for (var u = 0; u < c; u += 2) if (o = s[u], a = s[u + 1], h = s[(u + 2) % c], l = s[(u + 3) % c], 
            a != l && !(n.y < Math.min(a, l) || n.y >= Math.max(a, l))) {
        ...
        return n(t, "laya.utils.Stat"), r(1, t, "onclick", null, function(e) {
            ...
            void 0 === e && (e = 0), void 0 === i && (i = 0), !B.isConchApp || B.isConchWebGL ? (B.isConchWebGL || H.onMiniGame || H.onLimixiu || (t._useCanvas = !0), 
            ...
            t._canvas || ((t._canvas = new Nt("2D")).size(t._width, t._height), (t._ctx = t._canvas.getContext("2d")).textBaseline = "top", 
            ...
            t._first = !0, t.loop(), t._first = !1, H.container.appendChild(t._canvas.source);
        }, t.createUI = function(e, i) {
            var s = t._sp, n = H.pixelRatio;
            s || (s = new It(), (t._leftText = new Rt()).pos(5, 5), t._leftText.color = "#ffffff", 
            s.addChild(t._leftText), (t._txt = new Rt()).pos(80 * n, 5), t._txt.color = "#ffffff", 
            s.addChild(t._txt), t._sp = s), s.pos(e, i);
            for (var r = "", o = 0; o < t._view.length; o++) {
                r += t._view[o].title + "\n";
            }
            t._leftText.text = r;
            var a = 138 * n, h = n * (12 * t._view.length + 3 * n) + 4;
            t._txt.fontSize = t._fontSize * n, t._leftText.fontSize = t._fontSize * n, s.size(a, h), 
            s.graphics.clear(), s.graphics.setAlpha(.5), s.graphics.drawRect(0, 0, a, h, "#999999"), 
            ...
            if (!(e - t._timer < 1e3)) {
                ...
                if (t.FPS = Math.round(1e3 * i / (e - t._timer)), t._show) {
                    ...
                    t._canvasStr = t.canvasReCache + "/" + t.canvasNormal + "/" + t.canvasBitmap, t.currentMemorySize = D.systemResourceManager.memorySize, 
        ...
        return s._init = function() {
            ...
            if (this.scale <= 0) this._lastTimer = this._now(); else {
                ...
                for (this._count = 0, o = 0, a = s.length; o < a; o++) if (null !== (h = s[o]).method) {
            ...
            if (h) {
                ...
                if (l) return l.repeat = s, l.userFrame = i, l.delay = n, l.caller = r, l.method = o, 
                l.args = a, l.exeTime = n + (i ? this.currFrame : this.currTimer + this._now() - this._lastTimer), 
                l;
            }
            return l = t._pool.length > 0 ? t._pool.pop() : new e(), l.repeat = s, l.userFrame = i, 
            l.delay = n, l.caller = r, l.method = o, l.args = a, l.exeTime = n + (i ? this.currFrame : this.currTimer + this._now() - this._lastTimer) + 1, 
            this._indexHandler(l), this._handlers.push(l), l;
        }, s._indexHandler = function(t) {
            var e = t.caller, i = t.method, s = e ? e.$_GID || (e.$_GID = tt.getGID()) : 0, n = i.$_TID || (i.$_TID = 1e5 * this._mid++);
            ...
            var i = t ? t.$_GID || (t.$_GID = tt.getGID()) : 0, s = e.$_TID || (e.$_TID = 1e5 * this._mid++);
        ...
        return e.to = function(t, e, i, s, n, r, o) {
            ...
            this._target = e, this._duration = n, this._ease = r || s.ease || t.easeNone, this._complete = o || s.complete, 
            this._delay = a, this._props = [], this._usedTimer = 0, this._startTimer = H.now(), 
            ...
            u ? a <= 0 ? this.firstStart(e, s, l) : (this._delayParam = [ e, s, l ], i.scaleTimer.once(a, this, this.firstStart, this._delayParam)) : this._initProps(e, s, l), 
            this;
            ...
            this._usedPool && (this.update = null, q.recover("tween", this));
        }, e.recover = function() {
            ...
            if (this.pause(), this._usedTimer = 0, this._startTimer = H.now(), this._delayParam) i.scaleTimer.once(this._delay, this, this.firstStart, this._delayParam); else {
            ...
            this._usedTimer >= this._duration || (this._startTimer = H.now() - this._usedTimer - this._delay, 
            ...
            q.getItemByClass("tween", t)._create(e, i, s, n, r, o, a, !0, h, !0);
        }, t.from = function(e, i, s, n, r, o, a, h) {
            return void 0 === o && (o = 0), void 0 === a && (a = !1), void 0 === h && (h = !0), 
            q.getItemByClass("tween", t)._create(e, i, s, n, r, o, a, !1, h, !0);
        ...
        return n(t, "laya.utils.Utils"), t.toRadian = function(e) {
            ...
            var n = i.stage, r = laya.utils.Utils.getGlobalPosAndScale(t), o = n._canvasTransform.clone(), a = o.tx, h = o.ty;
            ...
            l ? (c = s + r.y, u = e + r.x, c *= o.d, u *= o.a, 90 == i.stage.canvasDegree ? (c = a - c, 
            u += h) : (c += a, u = h - u)) : (c = e + r.x, u = s + r.y, c *= o.a, u *= o.d, 
            c += a, u += h);
            var _ = NaN, d = NaN;
            ...
            if (!t) return !1;
            var e, i, s = 0, n = t.length, r = B._context;
        ...
        function t() {
            ...
            this._freeIdArray = [], B.isWebGL && G.regCacheByFunction(tt.bind(this.startDispose, this), tt.bind(this.getCacheList, this));
        }
        ...
        return e.set = function(e, i) {
            ...
            } else "string" == typeof e || "number" == typeof e ? this._obj[e] = i : (e.$_GID || (e.$_GID = tt.getGID()), 
            this._obj[e.$_GID] = i);
        }, e.get = function(e) {
        ...
        return n(e, "laya.wx.mini.MiniAdpter"), e.getJson = function(t) {
            ...
            if (void 0 === s && (s = !1), void 0 === n && (n = !1), !(e._inited || (e._inited = !0, 
            (e.window = t).navigator.userAgent.indexOf("MiniGame") < 0))) {
                ...
                e.isZiYu || (rt.setNativeFileDir("/layaairGame"), rt.existDir(rt.fileNativeDir, l.create(e, e.onMkdirCallBack))), 
                e.systemInfo = wx.getSystemInfoSync(), e.window.focus = function() {}, i._getUrlPath = function() {}, 
                ...
                o.getPixelRatio = e.pixelRatio, e._preCreateElement = H.createElement, H.createElement = e.createElement, 
                o.createShaderCondition = e.createShaderCondition, tt.parseXMLFromString = e.parseXMLFromString, 
                jt._createInputElement = at._createInputElement, e.EnvConfig.load = xt.prototype.load, 
                xt.prototype.load = Ct.prototype.load, xt.prototype._loadImage = ot.prototype._loadImage, 
                E._baseClass = ht, ht.__init__(), e.onReciveData();
            }
        }, e.onReciveData = function() {
            laya.wx.mini.MiniAdpter.isZiYu && wx.onMessage(function(t) {
                "opendatacontext" == t.isLoad ? t.url && (rt.ziyuFileData[t.url] = t.atlasdata, 
                rt.ziyuFileTextureData[t.imgReadyUrl] = t.imgNativeUrl) : "openJsondatacontext" == t.isLoad && t.url && (rt.ziyuFileData[t.url] = t.atlasdata);
            });
            ...
            return i.focus = at.wxinputFocus, i.blur = at.wxinputblur, i.style = {}, i.value = 0, 
            ...
            if (!laya.wx.mini.MiniAdpter.isZiYu) {
                ...
                var n = rt.getFileInfo(i).md5, r = rt.getFileNativePath(n);
        ...
        e.AutoCacheDownFile = !1, e._measureText = null, e.parseXMLFromString = function(e) {
            var i;
            e = e.replace(/>\s+</g, "><");
            try {
        ...
        return n(e, "laya.wx.mini.MiniFileMgr"), e.isLocalNativeFile = function(t) {
            for (var e = 0, i = nt.nativefiles.length; e < i; e++) if (-1 != t.indexOf(nt.nativefiles[e])) return !0;
            return !1;
        }, e.getFileInfo = function(t) {
            ...
            void 0 === o && (o = "");
            var a;
            a = "" == n || -1 == n.indexOf("http://") && -1 == n.indexOf("https://") ? t : e.getFileNativePath(t), 
            e.fs.readFile({
                filePath: a,
                encoding: i,
                success: function(t) {
            ...
            void 0 === i && (i = "ascill"), void 0 === n && (n = ""), void 0 === r && (r = !1), 
            void 0 === o && (o = ""), void 0 === a && (a = !0), e.fs.readFile({
                filePath: t,
                encoding: i,
                success: function(o) {
            ...
            var o = t.split("/"), a = o[o.length - 1], h = e.getFileInfo(i), l = e.getFileNativePath(a), c = e.getCacheUseSize();
            h ? h.readyUrl != i ? e.fs.getFileInfo({
                filePath: t,
                success: function(t) {
                    r && c + 4194304 + t.size >= 52428800 && (t.size > nt.minClearSize && (nt.minClearSize = t.size), 
                    e.onClearCacheRes()), e.deleteFile(a, i, s, n, t.size);
                },
                fail: function(t) {
                    null != s && s.runWith([ 1, t ]);
                }
                ...
                filePath: t,
                success: function(o) {
                    r && c + 4194304 + o.size >= 52428800 && (o.size > nt.minClearSize && (nt.minClearSize = o.size), 
            ...
            var o = e.getFileInfo(i), a = e.getFileNativePath(o.md5);
            e.fs.unlink({
                filePath: a,
                success: function(o) {
                    var a = "" != t;
            ...
            if (null == e.filesListObj.fileUsedSize && (e.filesListObj.fileUsedSize = 0), s) {
                ...
                e.filesListObj[a] = {
                    ...
                    times: H.now(),
                    encoding: n
                }, e.filesListObj.fileUsedSize = parseInt(e.filesListObj.fileUsedSize) + o, e.writeFilesList(a, JSON.stringify(e.filesListObj), !0), 
                null != r && r.runWith([ 0 ]);
            } else if (e.filesListObj[a]) {
                var h = parseInt(e.filesListObj[a].size);
                e.filesListObj.fileUsedSize = parseInt(e.filesListObj.fileUsedSize) - h, delete e.filesListObj[a], 
                e.writeFilesList(a, JSON.stringify(e.filesListObj), !1), null != r && r.runWith([ 0 ]);
            }
        ...
        return t.prototype._loadImage = function(e) {
            if (nt.isZiYu) t.onCreateImage(e, this, !0); else {
                var i = !1;
                if (rt.isLocalNativeFile(e)) {
                    if (-1 != e.indexOf("http://") || -1 != e.indexOf("https://")) if ("" != rt.loadPath) e = e.split(rt.loadPath)[1]; else {
            ...
            var r;
            if (nt.autoCacheFile) if (i) if (nt.isZiYu) {
                var o = R.formatURL(t);
                r = rt.ziyuFileTextureData[o] ? rt.ziyuFileTextureData[o] : t;
            } else r = t; else if ("" != s) r = s; else {
            ...
            "nativeimage" == e._type ? ((h = new H.window.Image()).crossOrigin = "", h.onload = l, 
            h.onerror = c, h.src = r, e.imgCache[t] = h) : new Zt.create(r, {
                onload: l,
                onerror: c,
                onCreate: function(i) {
                    h = i, e.imgCache[t] = i;
        ...
        return n(e, "laya.wx.mini.MiniInput"), e._createInputElement = function() {
            jt._initInput(jt.area = H.createElement("textarea")), jt._initInput(jt.input = H.createElement("input")), 
            jt.inputContainer = H.createElement("div"), jt.inputContainer.style.position = "absolute", 
            jt.inputContainer.style.zIndex = 1e5, H.container.appendChild(jt.inputContainer), 
            jt.inputContainer.setPos = function(t, e) {
            ...
            var s = nt.systemInfo.model, n = nt.systemInfo.system;
            -1 != s.indexOf("iPhone") && (H.onIPhone = !0, H.onIOS = !0, H.onIPad = !0, H.onAndroid = !1), 
            -1 == n.indexOf("Android") && -1 == n.indexOf("Adr") || (H.onAndroid = !0, H.onIPhone = !1, 
            H.onIOS = !1, H.onIPad = !1);
            ...
            e && !e.editable || (nt.window.wx.offKeyboardConfirm(), nt.window.wx.offKeyboardInput(), 
            nt.window.wx.showKeyboard({
                defaultValue: e.text,
        ...
        return n(t, "fly.ui.UIHelper"), t.getOjbsByName = function(e) {
            ...
            for (t.i = 0, t.count = e.numChildren; t.i < t.count; t.i++) if (t.obj = e.getChildAt(t.i), 
            i.__typeof(t.obj, s)) return t.obj;
            return null;
        }, t.savePos = function(t) {
            t.X = t.x, t.Y = t.y;
        }, t.resetPos = function(t) {
            t.x = t.X, t.y = t.Y;
        }, t.saveSize = function(t) {
            t.W = t.width, t.H = t.height;
        }, t.resetSize = function(t) {
        ...
        }, t.hideArr = function(e) {
            var i;
            for (var s in e) i = e[s], console.log(i), t.hide(i);
        }, t.showArr = function(e) {
            var i;
            for (var s in e) i = e[s], t.show(i);
        }, t.hide = function(e) {
            if (null != e && e.visible) {
                if (null == e.parent) return;
                null == (t.obj = t.dic.get(e)) && t.dic.set(e, t.obj = e.parent), e.parent == t.obj && t.obj.removeChild(e), 
                e.visible = !1;
            }
        }, t.show = function(e, i) {
            void 0 === i && (i = 99999), null != e && (e.visible || ((t.obj = t.dic.get(e)) && t.obj.addChildAt(e, Math.min(t.obj.numChildren, i)), 
            e.visible = !0));
        }, t.showHide = function(e, i, s) {
            void 0 === s && (s = 99999), e ? t.show(i, s) : t.hide(i);
        }, t._getObjByName = function(e, i) {
            for (var s, n = 0, r = e.numChildren; n < r; n++) null != (s = e.getChildAt(n)).name && "" != s.name && (i[s.name] = s, 
            s instanceof laya.ui.Box && t._getObjByName(s, i[s.name]));
            ...
            t.parent && t.parent.setChildIndex(t, t.parent.numChildren - 1);
        }, t.bottom = function(t) {
            t.parent && t.parent.setChildIndex(t, 0);
        ...
        function e() {
            ...
            this._$P = e.PROP_EMPTY, this.timer = i.scaleTimer, this.conchModel = B.isConchNode ? this.createConchModel() : null;
        }
        ...
        return s.getFriendScore = function() {
            var t = this;
            this.wx && this.wx.getFriendCloudStorage && this.wx.getFriendCloudStorage({
                keyList: [ "score" ],
                success: function(e) {
            ...
            var e = this;
            this.wx && this.wx.getGroupCloudStorage && this.wx.getGroupCloudStorage({
                shareTicket: t,
                keyList: [ "score" ],
                success: function(t) {
        ...
        function e() {
            ...
            this.lock = !1, this._memorySize = 0, this._lastUseFrameCount = -1, D.currentResourceManager && D.currentResourceManager.addResource(this);
        }
        ...
        return i.imps(s, {
            ...
            if (!this._destroyed) {
                ...
                0 === t.length && delete e._urlResourcesMap[this.url]), xt.clearRes(this._url), 
            ...
            if (t) {
                ...
                if (s) for (var n = s.slice(), r = 0, o = n.length; r < o; r++) (i = n[r]).lock || 0 !== i._referenceCount || i.destroy();
        ...
        return o.create = function(t, e, i, s, n, r, o, a) {
            ...
            var u = R.formatURL(t), _ = this.getRes(u);
            if (_) !_.hasOwnProperty("loaded") || _.loaded ? (n && n.runWith(1), s && s.run()) : s && i.loader._createListener(t, s.caller, s.method, s.args, !0, !1); else {
                var d = tt.getFileExtension(t), f = e.createMap[d];
                if (!f) throw new Error("LoaderManager:unknown file(" + t + ") extension with: " + d + ".");
                r || (r = f[0]);
                var p = f[1];
                "atlas" == d ? this.load(t, s, n, p, a, h) : (r === wt && (p = "htmlimage"), (_ = r ? new r() : null).hasOwnProperty("_loaded") && (_._loaded = !1), 
            ...
            t instanceof Array) return this._loadAssets(t, s, n, o, a, h, l);
            var _ = xt.getRes(t);
            if (null != _) i.timer.frameOnce(1, null, function() {
                n && n.runWith(1), s && s.runWith(_), u._loaderCount || u.event("complete");
            }); else {
                var d = e._resMap[t];
                d ? (s && d._createListener("complete", s.caller, s.method, s.args, !1, !1), n && d._createListener("progress", n.caller, n.method, n.args, !1, !1)) : ((d = this._infoPool.length ? this._infoPool.pop() : new r()).url = t, 
                d.type = o, d.cache = h, d.group = l, d.ignoreCache = c, s && d.on("complete", s.caller, s.method, s.args), 
                n && d.on("progress", n.caller, n.method, n.args), e._resMap[t] = d, a = a < this._maxPriority ? a : this._maxPriority - 1, 
            ...
            s instanceof Array) return this._loadAssets(s, n, o, a, h, l, c);
            var d = xt.getRes(s);
            if (null != d) i.timer.frameOnce(1, null, function() {
                o && o.runWith(1), n && n.runWith(d), _._loaderCount || _.event("complete");
            }); else {
                var f = e._resMap[s];
                f ? (n && f._createListener("complete", n.caller, n.method, n.args, !1, !1), o && f._createListener("progress", o.caller, o.method, o.args, !1, !1)) : ((f = this._infoPool.length ? this._infoPool.pop() : new r()).url = s, 
                f.clas = t, f.type = a, f.cache = l, f.group = c, f.ignoreCache = u, n && f.on("complete", n.caller, n.method, n.args), 
                o && f.on("progress", o.caller, o.method, o.args), e._resMap[s] = f, h = h < this._maxPriority ? h : this._maxPriority - 1, 
            ...
            function e(e) {
                i.offAll(), i._data = null, i._customParse = !1, s._loaders.push(i), s._endLoad(t, e instanceof Array ? [ e ] : e), 
            ...
            this._failRes[n] && (this._failRes[n] = 0), delete e._resMap[n], t.event("complete", s), 
        ...
        return i.dispose = function() {
            ...
            var r;
            if (t == k._tMusic ? (e._initMusicAudio(), (r = e._musicAudio).src != t && (e._audioCache[r.src] = null, 
            r = null)) : r = e._audioCache[t], r && r.readyState >= 2) this.event("complete"); else {
                r || (t == k._tMusic ? (e._initMusicAudio(), r = e._musicAudio) : r = H.createElement("audio"), 
            ...
            var n;
            n = q.getItem("audio:" + this.url), B.isConchApp ? n || ((n = H.createElement("audio")).src = this.url) : this.url == k._tMusic ? (e._initMusicAudio(), 
            (n = e._musicAudio).src = this.url) : n = n || s.cloneNode(!0);
            var r = new Lt(n);
            return r.url = this.url, r.loops = i, r.startTime = t, r.play(), k.addChannel(r), 
            r;
            ...
            H.document.removeEventListener("mousedown", e._makeMusicOK), e._musicAudio.src ? e._musicAudio.play() : (e._musicAudio.src = "", 
            e._musicAudio.load());
        ...
        return i.load = function(t) {
            ...
            i.startTime = t, i.play(), k.addChannel(i), i;
        }, i.dispose = function() {
            ...
            e._unlocked || (e._playEmptySound(), "running" == e.ctx.state && (H.document.removeEventListener("mousedown", e._unlock, !0), 
            H.document.removeEventListener("touchend", e._unlock, !0), H.document.removeEventListener("touchstart", e._unlock, !0), 
            e._unlocked = !0));
        }, e.initWebAudio = function() {
            "running" != e.ctx.state && (e._unlock(), H.document.addEventListener("mousedown", e._unlock, !0), 
            H.document.addEventListener("touchend", e._unlock, !0), H.document.addEventListener("touchstart", e._unlock, !0));
        }, e._dataCache = {}, e.buffs = [], e.isDecoding = !1, e._unlocked = !1, e.tInfo = null, 
        e.__loadingSound = {}, s(e, [ "window", function() {
        ...
        return i.send = function(t, e, i, s, n) {
            ...
            if (o.open(i, t, !0), n) for (var a = 0; a < n.length; a++) o.setRequestHeader(n[a++], n[a]); else B.isConchApp || (e && "string" != typeof e ? o.setRequestHeader("Content-Type", "application/json") : o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"));
        ...
        return s.load = function(t, i, s, n, r) {
            ...
            t = R.formatURL(t)), this._cache = s, this._data = null, !r && e.loadedMap[t]) return this._data = e.loadedMap[t], 
            ...
            "nativeimage" === this._type ? ((s = new H.window.Image()).crossOrigin = "", s.onload = r, 
            s.onerror = o, s.src = t, e.imgCache[t] = s) : new Zt.create(t, {
                onload: r,
                onerror: o,
                onCreate: function(i) {
                    s = i, e.imgCache[t] = i;
            ...
            var i = new k._soundClass(), s = this;
            ...
            if ("plf" == i) this.parsePLFData(t), this.complete(t); else if ("image" === i) {
                ...
                if (!t.src && !t._setContext) {
                    if (!this._data) {
                        if (this._data = t, t.meta && t.meta.image) for (var n = t.meta.image.split(","), r = this._url.indexOf("/") >= 0 ? "/" : "\\", o = this._url.lastIndexOf(r), a = o >= 0 ? this._url.substr(0, o + 1) : "", h = 0, l = n.length; h < l; h++) n[h] = a + n[h]; else n = [ this._url.replace(".json", ".png") ];
                ...
                var c = this._data.frames, u = this._url.split("?")[0], _ = this._data.meta && this._data.meta.prefix ? this._data.meta.prefix : u.substring(0, u.lastIndexOf(".")) + "/", f = this._data.pics, p = R.formatURL(this._url), g = e.atlasMap[p] || (e.atlasMap[p] = []);
                g.dir = _;
                var m = 1;
                if (this._data.meta && this._data.meta.scale && 1 != this._data.meta.scale) {
                    m = parseFloat(this._data.meta.scale);
                    for (var v in c) {
                        var y = c[v], x = f[y.frame.idx ? y.frame.idx : 0], w = R.formatURL(_ + v);
                        x.scaleRate = m;
                        var b;
                        b = wt.create(x, y.frame.x, y.frame.y, y.frame.w, y.frame.h, y.spriteSourceSize.x, y.spriteSourceSize.y, y.sourceSize.w, y.sourceSize.h), 
                        e.cacheRes(w, b), b.url = w, g.push(w);
                    }
                } else for (v in c) x = f[(y = c[v]).frame.idx ? y.frame.idx : 0], w = R.formatURL(_ + v), 
                e.cacheRes(w, wt.create(x, y.frame.x, y.frame.y, y.frame.w, y.frame.h, y.spriteSourceSize.x, y.spriteSourceSize.y, y.sourceSize.w, y.sourceSize.h)), 
                e.loadedMap[w].url = w, g.push(w);
                ...
                var S = this._url.split(".fnt")[0].split("/"), T = S[S.length - 1];
                Rt.registerBitmapFont(T, C), this._data = C, this.complete(this._data);
            } else if ("pkm" == i) {
                var M = Zt.create(t, this._url), I = new wt(M);
            ...
            e._isWorking = !0;
            for (var t = H.now(); e._startIndex < e._loaders.length; ) if (H.now(), e._loaders[e._startIndex].endLoad(), 
            e._startIndex++, H.now() - t > e.maxTimeOut) return console.warn("loader callback cost a long time:" + (H.now() - t) + " url=" + e._loaders[e._startIndex - 1].url), 
        ...
        function s(t, e) {
            ...
            s.__super.call(this), t && null != t._addReference && t._addReference(), this.setTo(t, e);
        }
        ...
        return a._setUrl = function(t) {
            ...
            if (void 0 === t && (t = !1), this.bitmap && this.bitmap.referenceCount > 0) {
                var e = this.bitmap;
                t ? (B.isConchApp && e.source && e.source.conchDestroy && this.bitmap.source.conchDestroy(), 
                this.bitmap = null, e.dispose(), e._clearReference()) : (e._removeReference(), 0 == e.referenceCount && (B.isConchApp && e.source && e.source.conchDestroy && this.bitmap.source.conchDestroy(), 
            ...
            i.onload = function() {
                ...
                s.event("loaded", this), o.addToAtlas && o.addToAtlas(s);
            };
            ...
            !t && B.isWebGL && (t || -1 != this.bitmap.minFifter || -1 != this.bitmap.magFifter || (this.bitmap.minFifter = 9728, 
            ...
            var u = t instanceof laya.resource.Texture, _ = u ? t.uv : s.DEF_UV, d = u ? t.bitmap : t, f = o.isAtlas(d);
            if (f) {
            ...
            m.width = n, m.height = r, m.offsetX = a, m.offsetY = h, m.sourceWidth = l || n, 
            m.sourceHeight = c || r;
            var v = 1 / d.width, y = 1 / d.height;
            e *= v, i *= y, n *= v, r *= y;
            var x = m.uv[0], w = m.uv[1], b = m.uv[4], C = m.uv[5], S = b - x, T = C - w, M = s.moveUV(_[0], _[1], [ e, i, e + n, i, e + n, i + r, e, i + r ]);
            m.uv = [ x + M[0] * S, w + M[1] * T, b - (1 - M[2]) * S, w + M[3] * T, b - (1 - M[4]) * S, C - (1 - M[5]) * T, x + M[6] * S, C - (1 - M[7]) * T ], 
            ...
            var o = t.scaleRate;
            1 != o && (e *= o, i *= o, n *= o, r *= o);
            var a = L.TEMP.setTo(e - t.offsetX, i - t.offsetY, n, r), h = a.intersection(s._rect1.setTo(0, 0, t.width, t.height), s._rect2);
            if (!h) return null;
            var l = s.create(t, h.x, h.y, h.width, h.height, h.x - a.x, h.y - a.y, n, r);
            return l.bitmap._removeReference(), l;
        }, s.DEF_UV = [ 0, 0, 1, 0, 1, 1, 0, 1 ], s.INV_UV = [ 0, 1, 1, 1, 1, 0, 0, 0 ], 
        s._rect1 = new L(), s._rect2 = new L(), s;
    }(), bt = function(t) {
        function e() {
        ...
        return s.destroy = function() {
            ...
            var t = this._source;
            if (t && t.bitmap) {
                var i = this.width, s = this.height, n = this._sizeGrid, r = t.sourceWidth, o = t.sourceHeight;
                if (!n || r === i && o === s) this.cleanByTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, i, s); else {
                    t.$_GID || (t.$_GID = tt.getGID());
                    var a = t.$_GID + "." + i + "." + s + "." + n.join(".");
                    if (tt.isOKCmdList(it.I.get(a))) return void (this.cmds = it.I.get(a));
                    this.clear();
                    var h = n[0], l = n[1], c = n[2], u = n[3], _ = n[4], d = !1;
                    ...
                    u && c && this.drawTexture(e.getTexture(t, 0, o - c, u, c), 0, s - c, u, c), l && c && this.drawTexture(e.getTexture(t, r - l, o - c, l, c), i - l, s - c, l, c), 
                    h && this.drawBitmap(_, e.getTexture(t, u, 0, r - u - l, h), u, 0, i - u - l, h), 
                    c && this.drawBitmap(_, e.getTexture(t, u, o - c, r - u - l, c), u, s - c, i - u - l, c), 
                    u && this.drawBitmap(_, e.getTexture(t, 0, h, u, o - h - c), 0, h, u, s - h - c), 
                    l && this.drawBitmap(_, e.getTexture(t, r - l, h, l, o - h - c), i - l, h, l, s - h - c), 
                    this.drawBitmap(_, e.getTexture(t, u, h, r - u - l, o - h - c), u, h, i - u - l, s - h - c), 
                    d && this.restore(), this.autoCacheCmd && !B.isConchApp && it.I.set(a, this.cmds);
                }
                this._repaint();
            }
            ...
            var r = t.$_GID + "." + e + "." + i + "." + s + "." + n, o = it.I.get(r);
            return o && o.source || (o = wt.createFromTexture(t, e, i, s, n), it.I.set(r, o)), 
            o;
        }, e;
    }(_), Ct = function(t) {
        function e() {
        ...
        return e.prototype.load = function(t, i, s, n, r) {
            ...
            this._cache = s, this._data = null, !r && xt.loadedMap[R.formatURL(t)]) return this._data = xt.loadedMap[R.formatURL(t)], 
            this.event("progress", 1), void this.event("complete", this._data);
            ...
            var o = nt.getUrlEncode(t, i), a = tt.getFileExtension(t);
            if (-1 != e._fileTypeArr.indexOf(a)) nt.EnvConfig.load.call(this, t, i, s, n, r); else {
                ...
                if (rt.getFileInfo(t)) {
                    ...
                    var u = t;
                    -1 != (t = R.formatURL(t)).indexOf("http://") || -1 != t.indexOf("https://") ? nt.EnvConfig.load.call(this, u, i, s, n, r) : rt.readFile(t, o, new l(e, e.onReadNativeCallBack, [ o, t, i, s, n, r, this ]), t);
                }
            }
        }, e.onReadNativeCallBack = function(t, e, i, s, n, r, o, a, h) {
            if (void 0 === s && (s = !0), void 0 === r && (r = !1), void 0 === a && (a = 0), 
            a) 1 == a && (console.log("-----------本地加载失败，尝试外网加载----"), nt.EnvConfig.load.call(o, e, i, s, n, r)); else {
                var l;
                l = "json" == i || "atlas" == i ? nt.getJson(h.data) : "xml" == i ? tt.parseXMLFromString(h.data) : h.data, 
                !nt.isZiYu && nt.isPosMsgYu && "arraybuffer" != i && wx.postMessage({
                    url: e,
                    data: l,
                    isLoad: "filedata"
                }), o.onLoaded(l);
        ...
        return i.load = function(t) {
            if (rt.isLocalNativeFile(t)) {
                if (-1 != t.indexOf("http://") || -1 != t.indexOf("https://")) if ("" != rt.loadPath) t = t.split(rt.loadPath)[1]; else {
            ...
            var s;
            if (this.url == k._tMusic ? (e._musicAudio || (e._musicAudio = e._createSound()), 
            s = e._musicAudio) : s = e._audioCache[this.readyUrl] ? e._audioCache[this.readyUrl]._sound : e._createSound(), 
            nt.autoCacheFile && rt.getFileInfo(this.url)) {
        ...
        function e(t) {
            ...
            this._aligns = e._ALIGNS, this._font = p.EMPTY, this._ower = t;
        }
        ...
        return i.destroy = function() {
            ...
            function s(t) {
                ...
                o.width && (n.width = i(e, s, o.width)), o.height && (n.height = i(e, s, o.height)), 
                o.left && (n.x = i(e, s, o.left)), o.top && (n.y = i(e, s, o.top));
            }
            if (e.indexOf("%") < 0) return !1;
            var n = this._ower, r = n.parent, o = this._rect;
            ...
            a[2] = parseFloat(a[2])), o[t] = a, o.input[t] = e, s(), !0;
            ...
            this._createFont().stroke === p._STROKE && (this._font.stroke = [ 0, "#000000" ]), 
            ...
            if ("none" != t) {
                ...
                var e = t.split(" ");
                if (this._border.color = U.create(e[e.length - 1]), 1 == e.length) return this._border.size = 1, 
            ...
            t ? (this._border || (this._border = {
                size: 1,
                type: "solid"
            }), this._border.color = null == t ? null : U.create(t), this._ower.conchModel && this._ower.conchModel.border(this._border.color.strColor), 
        ...
        function a() {
            ...
            a.__super.call(this), this._style = f.EMPTY;
        }
        ...
        return i.imps(h, {
            ...
            if (8 != s.length && (s = t ? T.scanPList(s) : L._getWrapRec(s, L.TEMP)._getBoundPoints()), 
            !this.transform) return tt.transPointList(s, this._x - e, this._y - i), s;
            var n = P.TEMP, r = 0, o = s.length;
            for (r = 0; r < o; r += 2) n.x = s[r], n.y = s[r + 1], this.toParentPoint(n), s[r] = n.x, 
            s[r + 1] = n.y;
            return s;
            ...
            if (this._$P.temBM || this._set$P("temBM", []), this.scrollRect) {
                var e = tt.clearArray(this._$P.temBM), i = L.TEMP;
            ...
            if (e.rotate || 1 !== i || 1 !== s || e.skewX || e.skewY) {
                ...
                var n = .0174532922222222 * (e.rotate - e.skewX), r = .0174532922222222 * (e.rotate + e.skewY), o = Math.cos(r), a = Math.sin(r), h = Math.sin(n), l = Math.cos(n);
            ...
            Z.spriteCount++, O.renders[this._renderType]._fun(this, t, e + this._x, i + this._y), 
            this._repaint = 0;
        }, h.drawToCanvas = function(t, e, i, s) {
            if (B.isConchNode) {
                var n = Nt.create("2D");
                return new F(t, e, n).ctx.setCanvasType(1), this.conchModel.drawToCanvas(n.source, i, s), 
                n;
            }
            ...
            this._setBit(2, !0), this._parent && this._$2__onDisplay(), this._createListener(t, i, s, n, !1)) : e.prototype.on.call(this, t, i, s, n);
        }, h.once = function(t, i, s, n) {
            return 1 !== this._mouseEnableState && this.isMouseEvent(t) ? (this.mouseEnabled = !0, 
            this._setBit(2, !0), this._parent && this._$2__onDisplay(), this._createListener(t, i, s, n, !0)) : e.prototype.once.call(this, t, i, s, n);
            ...
            void 0 === o && (o = .92), this._$P.dragging || this._set$P("dragging", new $()), 
            this._$P.dragging.start(this, t, e, i, s, n, r, o);
        }, h.stopDrag = function() {
            ...
            if (t && (this._renderType |= 1024, B.isConchNode)) {
                ...
                var e = new Nt("2d");
                e._setContext(new CanvasRenderingContext2D()), this.customContext = new F(0, 0, e), 
            ...
            if (t !== (e ? e.type : "none")) {
                if ("none" !== t) this._getBit(1) || this._setUpNoticeType(1), e || (e = this._set$P("cacheCanvas", q.getItemByClass("cacheCanvas", Object))), 
                ...
                this._set$P("cacheForFilters", !1); else if (this._$P._mask) ; else if (this._$P.hasFilter) this._set$P("cacheForFilters", !0); else {
                    if (e) {
                        var i = e;
                        i && i.ctx && (q.recover("RenderContext", i.ctx), i.ctx.canvas.size(0, 0), i.ctx = null), 
                        q.recover("cacheCanvas", e);
                    }
            ...
            B.isConchApp && (this.conchModel && (a.RUNTIMEVERION < "0.9.1" ? this.conchModel.removeType(16) : this.conchModel.removeType(32)), 
            this._$P.filters && 1 == this._$P.filters.length && this._$P.filters[0].callNative(this)), 
            B.isWebGL && (t && t.length ? this._renderType |= 32 : this._renderType &= -33), 
            t && t.length > 0 ? (this._getBit(1) || this._setUpNoticeType(1), B.isWebGL && 1 == t.length && t[0] instanceof laya.filters.ColorFilter || ("bitmap" != this.cacheAs && (B.isConchNode || (this.cacheAs = "bitmap"), 
        ...
        function e(t) {
            ...
            this._onEnd = tt.bind(this.__onEnd, this), this._resumePlay = tt.bind(this.__resumePlay, this), 
        ...
        return s.__onEnd = function() {
            ...
            try {
                this._audio.currentTime = this.startTime, H.container.appendChild(this._audio), 
                this._audio.play();
            } catch (t) {
                this.event("error");
            }
            ...
            this.isStopped = !0, k.removeChannel(this), this.completeHandler = null, this._audio && ("pause" in this._audio && B.isConchApp && this._audio.stop(), 
            ...
            H.onIE || this._audio != pt._musicAudio && q.recover("audio:" + this.url, this._audio), 
            H.removeElement(this._audio), this._audio = null);
        }, s.pause = function() {
        ...
        function e() {
            ...
            this.context = vt.ctx, e.__super.call(this), this._onPlayEnd = tt.bind(this.__onPlayEnd, this), 
        ...
        return s.play = function() {
            if (k.addChannel(this), this.isStopped = !1, this._clearBufferSource(), this.audioBuffer) {
                ...
                this._startTime = H.now(), this.gain.gain.setTargetAtTime ? this.gain.gain.setTargetAtTime(this._volume, this.context.currentTime, .1) : this.gain.gain.value = this._volume, 
                0 == this.loops && (i.loop = !0), i.playbackRate.setTargetAtTime ? i.playbackRate.setTargetAtTime(k.playbackRate, this.context.currentTime, .1) : i.playbackRate.value = k.playbackRate, 
            ...
            this.isStopped = !0, k.removeChannel(this), this.completeHandler = null, k.autoReleaseSound && i.timer.once(5e3, null, k.disposeSoundIfNotUsed, [ this.url ], !1);
        }, s.pause = function() {
            this.isStopped || (this._pauseTime = this.position), this._clearBufferSource(), 
            this.gain && this.gain.disconnect(), this.isStopped = !0, k.removeChannel(this), 
            k.autoReleaseSound && i.timer.once(5e3, null, k.disposeSoundIfNotUsed, [ this.url ], !1);
        }, s.resume = function() {
        ...
        return s.__onEnd = function() {
            ...
            this.isStopped = !0, k.removeChannel(this), this.completeHandler = null, this._audio && (this._audio.pause(), 
        ...
        function e() {
            ...
            this._layout = z.EMPTY, this.preinitialize(), this.createChildren(), this.initialize();
        }
        ...
        s.callLater = function(t, e) {
            ...
            i.superGet(It, this, "scaleY") != t && (i.superSet(It, this, "scaleY", t), this.callLater(this.changeSize), 
            ...
            i.superGet(It, this, "scaleX") != t && (i.superSet(It, this, "scaleX", t), this.callLater(this.changeSize), 
        ...
        return o.destroy = function(e) {
            ...
            H.context.font = s;
            var n = this.padding, r = n[3], o = "left", a = this._lines, h = this.leading + this._charSize.height, l = this._currBitmapFont;
            l && (h = this.leading + l.getMaxHeight());
            var c = n[0];
            if (!l && this._width > 0 && this._textWidth <= this._width && ("right" == this.align ? (o = "right", 
            r = this._width - n[1]) : "center" == this.align && (o = "center", r = .5 * this._width + n[3] - n[1])), 
            this._height > 0) {
            ...
            for (var m = 0, v = 0, y = Math.min(this._lines.length, e + t) || 1, x = t; x < y; x++) {
                ...
                if (m = r - (this._clipPoint ? this._clipPoint.x : 0), v = c + h * x - (this._clipPoint ? this._clipPoint.y : 0), 
                this.underline && this.drawUnderline(o, m, v, x), l) {
                    var T = this.width;
                    l.autoScaleSize && (T = this.width * d), l.drawText(b, this, m, v, this.align, T);
                } else B.isWebGL ? (this._words || (this._words = []), (w = this._words.length > x - t ? this._words[x - t] : new st()).setText(b)) : w = b, 
                _.stroke ? i.fillBorderText(w, m, v, s, this.color, _.strokeColor, _.stroke, o) : i.fillText(w, m, v, s, this.color, o);
            }
            ...
            H.context.font = this._getCSSStyle().font, this._lines.length = 0, this._lineWidths.length = 0, 
            this._isPassWordMode() ? this.parseLines(this._getPassWordTxt(this._text)) : this.parseLines(this._text), 
            this.evalTextSize(), this.checkEnabledViewportOrNot() ? this._clipPoint || (this._clipPoint = new P(0, 0)) : this._clipPoint = null;
            ...
            this._charSize.height = this._currBitmapFont.getMaxHeight(); else {
                ...
                B.isConchApp && 0 === n.width && 0 === n.height && (n = H.context.measureText("W")), 
            ...
            H.context;
            var s, n = this._lines, r = 0, o = NaN, a = NaN, h = 0;
            ...
            (a += o) > i) if (this.wordWrap) {
                ...
                if (u.charCodeAt(u.length - 1) < 255 ? (s = /(?:\w|-)+$/.exec(u)) && (l = s.index + h, 
                0 == s.index ? l += u.length : u = t.substring(h, l)) : e.RightToLeft && (s = /([\u0600-\u06FF])+$/.exec(u)) && (l = s.index + h, 
                0 == s.index ? l += u.length : u = t.substring(h, l)), n.push(u), this._lineWidths.push(a - o), 
                h = l, !(l + r < c)) {
                    n.push(t.substring(h, c)), this._lineWidths.push(this.getTextWidth(n[n.length - 1])), 
                    h = -1;
                    break;
                }
            ...
            return (e = this._currBitmapFont && this._currBitmapFont.autoScaleSize ? this._width * (this._currBitmapFont.fontSize / this.fontSize) : this._width) <= 0 && (e = this.wordWrap ? 100 : H.width), 
            e <= 0 && (e = 100), e - t[3] - t[1];
            ...
            var t;
            (t = H.canvas.source.style).display = "none", t.position = "absolute", t.direction = "rtl", 
            B._mainCanvas.source.style.direction = "rtl", laya.display.Text.RightToLeft = !0, 
            H.document.body.appendChild(H.canvas.source);
        ...
        function e() {
            ...
            this._actionName = null, e.__super.call(this), this._interval = u.animationInterval, 
        ...
        function e() {
            ...
            e.__super.call(this), this.offset = new P(), this._canvasTransform = new I(), this._previousOrientation = H.window.orientation;
            var t = this;
            this.transform = I.create(), this._scenes = [], this.mouseEnabled = !0, this.hitTestPrior = !0, 
            this.autoSize = !1, this._displayedInStage = !0, this._isFocused = !0, this._isVisibility = !0;
            var i = H.window, s = this;
            ...
            var n = "visibilityState", r = "visibilitychange", o = i.document;
            void 0 !== o.hidden ? (r = "visibilitychange", n = "visibilityState") : void 0 !== o.mozHidden ? (r = "mozvisibilitychange", 
            n = "mozVisibilityState") : void 0 !== o.msHidden ? (r = "msvisibilitychange", n = "msVisibilityState") : void 0 !== o.webkitHidden && (r = "webkitvisibilitychange", 
            n = "webkitVisibilityState"), i.document.addEventListener(r, function() {
                ...
                null != e && e != t._previousOrientation && s._isInputting() && (jt.inputElement.target.focus = !1), 
        ...
        return a._setStageVisible = function(t) {
            this._isVisibility != t && (this._isVisibility = t, this._isVisibility || this._isInputting() && (jt.inputElement.target.focus = !1), 
            ...
            var n = B._mainCanvas, r = n.source.style, a = this._canvasTransform.identity(), h = this._scaleMode, l = t / this.designWidth, c = e / this.designHeight, u = this.designWidth, _ = this.designHeight, d = t, f = e, p = H.pixelRatio;
            ...
            n.size(u, _), o.changeWebGLSize(u, _), a.scale(d / u / p, f / _ / p), "left" === this._alignH ? this.offset.x = 0 : "right" === this._alignH ? this.offset.x = (t - d) / p : this.offset.x = .5 * (t - d) / p, 
            ...
            if (this._renderCount++, B.isFlash && this.repaint(), this._style.visible) {
                ...
                if (Z.renderSlow = !a, a || h || B.isConchApp) {
                    ...
                    var l, c = 0, u = 0;
                    if (B.isConchNode) for (c = 0, u = this._scenes.length; c < u; c++) (l = this._scenes[c]) && l._updateSceneConch(); else for (c = 0, 
                ...
                B.isConchNode || this.renderingEnabled && (a || !h || B.isConchWebGL) && (B.isWebGL ? (e.clear(), 
                t.prototype.render.call(this, e, s, n), Z._show && Z._sp && Z._sp.render(e, s, n), 
                o.clear(this._bgColor), o.beginFlush(), e.flush(), o.endFinish(), et.instance && et.getInstance().endDispose()) : (o.clear(this._bgColor), 
                t.prototype.render.call(this, e, s, n), Z._show && Z._sp && Z._sp.render(e, s, n)));
            ...
            this._bgColor = t, this.conchModel && this.conchModel.bgColor(t), B.isWebGL && (t ? e._wgColor = U.create(t)._color : H.onMiniGame || (e._wgColor = null)), 
            H.onLimixiu ? e._wgColor = U.create(t)._color : B.canvas.style.background = t || "none";
        ...
        e.FRAME_SLEEP = "sleep", e.FRAME_MOUSE_THREDHOLD = 2e3, s(e, [ "_wgColor", function() {
        ...
        function e(t, i) {
            ...
            if (this._source = this, "2D" === t || "AUTO" === t && !B.isWebGL) {
                this._is2D = !0, this._source = i || H.createElement("canvas"), this._w = this._source.width, 
                this._h = this._source.height;
                var n = this;
                n.getContext = function(t, e) {
                    if (s._ctx) return s._ctx;
                    var i = s._ctx = s._source.getContext(t, e);
                    return i && (i._canvas = n, B.isFlash || H.onLimixiu || (i.size = function(t, e) {})), 
                    i;
                };
            }
            this.lock = !0;
        ...
        return i.clear = function() {
            ...
            if (this._source) if (B.isConchApp && this._source.toBase64) this._source.toBase64(t, e, i); else {
        ...
        function e(t, i) {
            ...
            this._clickHandler = null, this._stateChanged = !1, e.__super.call(this), this._labelColors = W.buttonLabelColors, 
            this._stateNum = W.buttonStateNum, void 0 === i && (i = ""), this.skin = t, this.label = i;
        }
        ...
        return i.imps(o, {
            ...
            this._text || (this._text = new Rt(), this._text.overflow = Rt.HIDDEN, this._text.align = "center", 
            ...
            if (t) {
                ...
                t.$_GID || (t.$_GID = tt.getGID());
                var s = t.$_GID + "-" + this._stateNum, n = it.I.get(s);
                if (tt.isOkTextureList(n) || (n = null), n) this._sources = n; else {
                    if (this._sources = [], 1 === this._stateNum) this._sources.push(t); else for (var r = 0; r < this._stateNum; r++) this._sources.push(wt.createFromTexture(t, 0, i * r, e, i));
        ...
        return s.destroy = function(e) {
            ...
            if (t === this._skin && e) {
                var i = this._clipWidth || Math.ceil(e.sourceWidth / this._clipX), s = this._clipHeight || Math.ceil(e.sourceHeight / this._clipY), n = this._skin + i + s, r = it.I.get(n);
                if (tt.isOkTextureList(r) || (r = null), r) this._sources = r; else {
                    this._sources = [];
                    for (var o = 0; o < this._clipY; o++) for (var a = 0; a < this._clipX; a++) this._sources.push(wt.createFromTexture(e, i * a, s * o, i, s));
        ...
        return s.destroy = function(e) {
            ...
            this.addChild(this._colorButton = new zt()), this._colorPanel = new Dt(), this._colorPanel.size(230, 166), 
            this._colorPanel.addChild(this._colorTiles = new It()), this._colorPanel.addChild(this._colorBlock = new It()), 
            this._colorPanel.addChild(this._colorInput = new jt());
            ...
            for (var e = [ 0, 3355443, 6710886, 10066329, 13421772, 16777215, 16711680, 65280, 255, 16776960, 65535, 16711935 ], i = 0; i < 12; i++) for (var s = 0; s < 20; s++) {
                ...
                var r = Y.toColor(n);
                this._colors.push(r);
                var o = s * this._gridSize, a = i * this._gridSize;
            ...
            var t = this.localToGlobal(new P()), e = t.x + this._colorPanel.width <= i.stage.width ? t.x : i.stage.width - this._colorPanel.width, s = t.y + this._colorButton.height;
            ...
            this.event("change", v.EMPTY.setTo("change", this, this)));
        }), r(0, s, "skin", function() {
        ...
        function e(t, i) {
            ...
            this._itemColors = W.comboBoxItemColors, this.skin = t, this.labels = i;
        }
        ...
        return s.destroy = function(e) {
            ...
            this.addChild(this._button = new zt()), this._button.text.align = "left", this._button.labelPadding = "0,0,0,5", 
            this._button.on("mousedown", this, this.onButtonMouseDown);
        }, s._createList = function() {
            this._list = new Qt(), this._scrollBarSkin && (this._list.vScrollBarSkin = this._scrollBarSkin), 
            this._setListEvent(this._list);
        }, s._setListEvent = function(t) {
            this._list.selectEnable = !0, this._list.on("mousedown", this, this.onListDown), 
            this._list.mouseHandler = l.create(this, this.onlistItemMouse, null, !1), this._list.scrollBar && this._list.scrollBar.on("mousedown", this, this.onScrollBarDown);
            ...
            this.event("change", [ v.EMPTY.setTo("change", this, this) ]), this._selectHandler && this._selectHandler.runWith(this._selectedIndex));
        }), r(0, s, "measureHeight", function() {
            ...
            i.superSet(At, this, "width", t), this._button.width = this._width, this._itemChanged = !0, 
            this._listChanged = !0;
            ...
            this._isOpen) {
                ...
                var e = this.localToGlobal(P.TEMP.setTo(0, 0)), s = e.y + this._button.height;
        ...
        function e(t) {
            ...
            this._offsets = null, e.__super.call(this), this._showButtons = lt.showButtons, 
            this._touchScrollEnable = lt.touchScrollEnable, this._mouseWheelEnable = lt.mouseWheelEnable, 
        ...
        return s.destroy = function(e) {
            ...
            this.addChild(this.slider = new Xt()), this.addChild(this.upButton = new zt()), 
            this.addChild(this.downButton = new zt());
        }, s.initialize = function() {
            ...
            this.slide(e), i.timer.once(W.scrollBarDelayTime, this, this.startLoop, [ e ]), 
            ...
            Q.clearTween(this), i.stage.once("mouseup", this, this.onStageMouseUp2), i.stage.once("mouseout", this, this.onStageMouseUp2), 
            ...
            this._isElastic) this._value < this.min ? Q.to(this, {
                value: this.min
            }, this.elasticBackTime, j.sineOut, l.create(this, this.elasticOver)) : this._value > this.max && Q.to(this, {
                value: this.max
            }, this.elasticBackTime, j.sineOut, l.create(this, this.elasticOver)); else {
            ...
            this._thumbPercent = t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, W.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, W.scrollBarMinNum));
        ...
        return o.destroy = function(e) {
            ...
            this._globalSacle || (this._globalSacle = new P()), this._globalSacle.setTo(this.globalScaleX || .01, this.globalScaleY || .01), 
            ...
            if (this._skin != t) {
                ...
                xt.getRes(e) && (this._progress || (this.addChild(this._progress = new Ut()), this._progress.sizeGrid = this._bar.sizeGrid, 
        ...
        function e(t) {
            this._tf = null, e.__super.call(this), void 0 === t && (t = ""), p.defaultColor = W.labelColor, 
            this.text = t;
        }
        n(e, "laya.ui.Label", t);
        var s = e.prototype;
        return s.destroy = function(e) {
            ...
            this._tf.text != t && (t && (t = Y.adptString(t + "")), this._tf.text = t, this.event("change"), 
        ...
        function e() {
            ...
            this._height = 20, this.multiline = !1, this.overflow = Rt.SCROLL, this.on("mousedown", this, this._onMouseDown), 
        ...
        return o.setSelection = function(t, e) {
            ...
            var t = this.nativeInput, s = tt.getTransformRelativeToWindow(this, this.padding[3], this.padding[0]), n = this._width - this.padding[1] - this.padding[3], r = this._height - this.padding[0] - this.padding[2];
            B.isConchApp ? (t.setScale(s.scaleX, s.scaleY), t.setSize(n, r), t.setPos(s.x, s.y)) : (e.inputContainer.style.transform = e.inputContainer.style.webkitTransform = "scale(" + s.scaleX + "," + s.scaleY + ") rotate(" + i.stage.canvasDegree + "deg)", 
            t.style.width = n + "px", t.style.height = r + "px", e.inputContainer.style.left = s.x + "px", 
            ...
            Rt.RightToLeft && (e.inputElement.style.direction = "rtl");
        }, o._focusIn = function() {
            ...
            B.isConchApp && (t.setType(this._type), t.setForbidEdit(!this._editable)), t.maxLength = this._maxChars;
            this.padding;
            ...
            i.stage.focus = this, this.event("focus"), H.onPC && t.focus(), !H.onMiniGame) {
                this._text;
                this._text = null;
            }
            this.typeset(), t.setColor(this._originColor), t.setFontSize(this.fontSize), t.setFontFace(H.onIPhone ? Rt._fontFamilyMap[this.font] || this.font : this.font), 
            B.isConchApp && t.setMultiAble && t.setMultiAble(this._multiline), e.lineHeight = this.leading + this.fontSize + "px", 
            e.fontStyle = this.italic ? "italic" : "normal", e.fontWeight = this.bold ? "bold" : "normal", 
            e.textAlign = this.align, e.padding = "0 0", this._syncInputTransform(), !B.isConchApp && H.onPC && i.timer.frameLoop(1, this, this._syncInputTransform);
        }, o._setPromptColor = function() {
            (e.promptStyleDOM = H.getElementById("promptStyle")) || ((e.promptStyleDOM = H.createElement("style")).setAttribute("id", "promptStyle"), 
            H.document.head.appendChild(e.promptStyleDOM)), e.promptStyleDOM.innerText = "input::-webkit-input-placeholder, textarea::-webkit-input-placeholder {color:" + this._promptColor + "}input:-moz-placeholder, textarea:-moz-placeholder {color:" + this._promptColor + "}input::-moz-placeholder, textarea::-moz-placeholder {color:" + this._promptColor + "}input:-ms-input-placeholder, textarea:-ms-input-placeholder {color:" + this._promptColor + "}";
        }, o._focusOut = function() {
            laya.display.Input.isInputting = !1, this._focus = !1, this._text = null, this._content = this.nativeInput.value, 
            this._content ? (i.superSet(Rt, this, "text", this._content), i.superSet(Rt, this, "color", this._originColor)) : (i.superSet(Rt, this, "text", this._prompt), 
            i.superSet(Rt, this, "color", this._promptColor)), i.stage.off("keydown", this, this._onKeyDown), 
            i.stage.focus = null, this.event("blur"), B.isConchApp && this.nativeInput.blur(), 
            H.onPC && i.timer.clear(this, this._syncInputTransform);
            ...
            this._focus && this.nativeInput.setColor(t), i.superSet(Rt, this, "color", this._content ? t : this._promptColor), 
            this._originColor = t;
            ...
            i.superSet(Rt, this, "color", this._originColor), t += "", this._focus ? (this.nativeInput.value = t || "", 
            this.event("change")) : (this._multiline || (t = t.replace(/\r?\n/g, "")), this._content = t, 
            t ? i.superSet(Rt, this, "text", t) : (i.superSet(Rt, this, "text", this._prompt), 
            i.superSet(Rt, this, "color", this.promptColor)));
        }), r(0, o, "nativeInput", function() {
            return this._multiline ? e.area : e.input;
        }), r(0, o, "prompt", function() {
            return this._prompt;
        }, function(t) {
            !this._text && t && i.superSet(Rt, this, "color", this._promptColor), this.promptColor = this._promptColor, 
            this._text ? i.superSet(Rt, this, "text", this._text == this._prompt ? t : this._text) : i.superSet(Rt, this, "text", t), 
            this._prompt = Rt.langPacks && Rt.langPacks[t] ? Rt.langPacks[t] : t;
        }), r(0, o, "focus", function() {
            return this._focus;
        }, function(t) {
            var i = this.nativeInput;
            this._focus !== t && (t ? (i.target ? i.target._focusOut() : this._setInputMethod(), 
            i.target = this, this._focusIn()) : (i.target = null, this._focusOut(), H.document.body.scrollTop = 0, 
            i.blur(), B.isConchApp ? i.setPos(-1e4, -1e4) : e.inputContainer.contains(i) && e.inputContainer.removeChild(i)));
            ...
            e._initInput(e.area = H.createElement("textarea")), e._initInput(e.input = H.createElement("input")), 
            (e.inputContainer = H.createElement("div")).style.position = "absolute", e.inputContainer.style.zIndex = 1e5, 
            H.container.appendChild(e.inputContainer), e.inputContainer.setPos = function(t, i) {
        ...
        e.isInputting = !1, e.stageMatrix = null, s(e, [ "IOS_IFRAME", function() {
        ...
        return s.destroy = function(t) {
            ...
            var o = this;
            return o._setFramesFromCache(n) || (xt.getAtlas(t) ? r(t) : i.loader.load(t, l.create(null, r, [ t ]), null, "atlas")), 
            this;
            ...
            this.index = 0, e && e.run()) : !s || xt.getAtlas(s) ? this._loadAnimationData(t, e, s) : i.loader.load(s, l.create(this, this._loadAnimationData, [ t, e, s ]), null, "atlas"), 
            this;
            ...
            if (!n || xt.getAtlas(n)) {
                var a = this;
                xt.getRes(t) ? r(t) : i.loader.load(t, l.create(null, r, [ t ]), null, "json"), 
                xt.clearRes(t);
            ...
            if ("string" == typeof t) {
                var h = xt.getAtlas(t);
                if (h && h.length) for (s = [], r = 0, a = h.length; r < a; r++) (n = new o.createGraphics()).drawTexture(xt.getRes(h[r]), 0, 0), 
                s.push(n);
            } else if (t instanceof Array) for (s = [], r = 0, a = t.length; r < a; r++) (n = new o.createGraphics()).loadImage(t[r], 0, 0), 
            s.push(n);
        ...
        function e() {
            ...
            e.__super.call(this), null == e._sortIndexFun && (e._sortIndexFun = M.sortByKey("index", !1, !0));
        }
        ...
        return i._setUp = function(t, e) {
            ...
            var s = i[t.target];
            if (s) {
                var n, r, o, a = t.frames, h = t.keys, l = 0, c = h.length;
                for (l = 0; l < c; l++) o = (r = a[n = h[l]]).length > e ? r[e] : r[r.length - 1], 
                s[n] = o;
            }
            ...
            0 == r && (e[t[0].index] = t[0].value, this._animationNewFrames && (this._animationNewFrames[t[0].index] = !0)), 
            this._dealKeyFrame(t[n]);
        }, i._dealKeyFrame = function(t) {
            t.label && "" != t.label && this.addLabel(t.label, t.index);
        }, i._calculateFrameValues = function(t, e, i) {
            var s, n = 0, r = t.index, o = e.index, a = t.value, h = e.value - t.value, l = o - r;
            if (o > this._count && (this._count = o), t.tween) for (null == (s = j[t.tweenMethod]) && (s = j.linearNone), 
            n = r; n < o; n++) i[n] = s(n - r, a, h, l), this._animationNewFrames && (this._animationNewFrames[n] = !0); else for (n = r; n < o; n++) i[n] = a;
        ...
        return i._init_ = function(t, e) {
            this._src = t, this._source = new H.window.Image(), e && (e.onload && (this.onload = e.onload), 
        ...
        return o.createView = function(t) {
            ...
            t.animations) {
                var i, s, n = [], r = t.animations, o = 0, a = r.length;
                for (o = 0; o < a; o++) {
                    switch (i = new qt(), s = r[o], i._setUp(this._idMap, s), this[s.name] = i, i._setControlNode(this), 
                    s.action) {
                      case 1:
                        i.play(0, !1);
                        break;
            ...
            null;
            var o = t.child;
            if (o) for (var a = s instanceof laya.ui.List, h = 0, l = o.length; h < l; h++) {
                var c = o[h];
                if (!s.hasOwnProperty("itemRender") || "render" != c.props.name && "render" !== c.props.renderType) if ("Graphic" == c.type) X.addGraphicsToSprite(c, s); else if (X.isDrawType(c.type)) X.addGraphicToSprite(c, s, !0); else {
                    if (a) {
                        var u = [], _ = e.createComp(c, null, n, u);
                ...
                if (a) a.push(t, s, n); else if (o) {
                    ...
                    for (var l, c, u = n.replace(/\[.*?\]\./g, "."); null != (l = e._parseWatchData.exec(u)); ) {
                        for (var _ = l[1]; null != (c = e._parseKeyWord.exec(_)); ) {
                            var d = c[0], f = o._watchMap[d] || (o._watchMap[d] = []);
            ...
            } else if ("var" === s && o) o[n] = t; else if ("onClick" == s) {
        ...
        function e() {
            ...
            this._cellChanged = !1, this._cells = [], this._offset = new P(), e.__super.call(this);
        }
        n(e, "laya.ui.List", t);
        var s = e.prototype;
        return i.imps(s, {
            ...
            this._$P.cacheAs || (this._$P.cacheAs = i.superGet(Dt, this, "cacheAs")), i.superSet(Dt, this, "cacheAs", "none"), 
            ...
            var s = this._content, n = this._getOneCell(), r = n.width + this._spaceX, o = n.height + this._spaceY;
            if (this.cacheContent) {
                var a = new Dt();
                a.cacheAsBitmap = !0, a.pos((this._isVertical ? 0 : t) * r, (this._isVertical ? t : 0) * o), 
                this._content.addChild(a), this._content.optimizeScrollRect = !0, s = a;
            } else {
            ...
            for (var u = t; u < i; u++) for (var _ = 0; _ < e; _++) (n = h && h.length ? h.pop() : this.createItem()).x = (this._isVertical ? _ : u) * r - s.x, 
            n.y = (this._isVertical ? u : _) * o - s.y, n.name = "item" + (u * e + _), s.addChild(n), 
            this.addCell(n);
        }, s.createItem = function() {
            var t = [];
            if ("function" == typeof this._itemRender) var e = new this._itemRender(); else e = Jt.createComp(this._itemRender, null, null, t);
            ...
            this._content.width = t, this._content.height = e, (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content.scrollRect || (this._content.scrollRect = new L()), 
            ...
            if (this.cacheContent) o = s + 1, this._createdLine - n < o && (this._createItems(this._createdLine, i, this._createdLine + o), 
            this.renderItems(this._createdLine * i, 0), this._createdLine += o); else {
                var r = n * i, o = 0;
                if (r > this._startIndex) {
                    o = r - this._startIndex;
                    var a = !0, h = this._startIndex + i * (s + 1);
                    this._isMoved = !0;
            ...
            for (var i = t._$bindData, s = 0, n = i.length; s < n; s++) {
                var r = i[s++], o = i[s++], a = i[s], h = Y.getBindFun(a);
                r[o] = h.call(this, e);
            }
        }, s.refresh = function() {
            ...
            i.superSet(Dt, this, "cacheAs", t), this._scrollBar && (this._$P.cacheAs = null, 
        ...
        return i.imps(s, {
            ...
            this.addChild(this._list = new Qt()), this._list.renderHandler = l.create(this, this.renderItem, null, !1), 
            ...
            var n, r = t.childNodes, o = r.length;
            if (!s) {
                n = {};
            ...
            for (var i = 0, s = e.length; i < s; i++) {
                var n = e[i];
                if (n.isDirectory) for (var r = 0, o = t.length; r < o; r++) {
                    var a = t[r];
        ...
        return s.destroy = function(t) {
            ...
            var t = this.contentWidth || 1, e = this.contentHeight || 1, i = this._vScrollBar, s = this._hScrollBar, n = i && e > this._height, r = s && t > this._width, o = n ? this._width - i.width : this._width, a = r ? this._height - s.height : this._height;
            ...
            var i = this._content;
            i.width = t, i.height = e, i.scrollRect || (i.scrollRect = new L()), i.scrollRect.setTo(0, 0, t, e), 
            ...
            null == this._hScrollBar && (laya.display.Node.prototype.addChild.call(this, this._hScrollBar = new he()), 
            ...
            null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new ce()), 
            ...
            i.superSet(Dt, this, "cacheAs", t), this._$P.cacheAs = null, "none" !== t ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), 
        ...
        return s.preinitialize = function() {
            ...
            this.addChild(this._tf = new jt()), this._tf.padding = W.inputLabelPadding, this._tf.on("input", this, this._onInput), 
            ...
            this._skin != t && (this._skin = t, this._bg || (this.graphics = this._bg = new bt()), 
            this._bg.source = xt.getRes(this._skin), this._width && (this._bg.width = this._width), 
        ...
        return r._parseNodeList = function(t) {
            ...
            return e._rootMatrix || (e._rootMatrix = new I()), this._updateNodeGraphic(this._rootNode, t, e._rootMatrix, i), 
            i;
            ...
            if (!(o < .01)) {
                ...
                var h;
                r.skin && (h = this._getTextureByUrl(r.skin)) && (a._checkTransform() ? (s.drawTexture(h, 0, 0, r.width, r.height, a, o), 
                r.resultTransform = null) : s.drawTexture(h, a.tx, a.ty, r.width, r.height, null, o));
                var l;
                if (l = t.child) {
                    var c = 0, u = 0;
            ...
            t.child) {
                ...
                var a = !1;
                (a = n.bTransform || 1 != s.alpha) && i.save(), 1 != s.alpha && i.alpha(s.alpha), 
                r ? o && i.translate(n.tx, n.ty) : i.transform(n.clone());
                var h;
                h = t.child;
                var l;
            ...
            if (!r) return n;
            var o = r.frames, a = this._getParams(o, e._drawTextureCmd, s, this._nodeDefaultProps[t]), h = a[0], l = NaN, c = NaN, u = a[5], _ = a[6], d = a[13], f = a[14], p = a[7], g = a[8], m = a[9], v = a[11], y = a[12];
            l = a[3], c = a[4], 0 != l && 0 != c || (h = null), -1 == l && (l = 0), -1 == c && (c = 0);
            var x;
            n.skin = h, n.width = l, n.height = c, h && ((x = this._getTextureByUrl(h)) ? (l || (l = x.sourceWidth), 
            c || (c = x.sourceHeight)) : console.warn("lost skin:", h, ",you may load pics first")), 
            n.alpha = a[10];
            var w;
            ...
            if (m || 1 !== p || 1 !== g || v || y) {
                ...
                var C = .0174532922222222 * (m - v), S = .0174532922222222 * (m + y), T = Math.cos(S), M = Math.sin(S), P = Math.sin(C), L = Math.cos(C);
            ...
            if (t.animations) {
                ...
                var s, n = {}, r = [], o = t.animations, a = 0, h = o.length;
                for (a = 0; a < h; a++) if (s = o[a], this._labels = null, (!i || i == s.name) && s) {
                    try {
            ...
            if (t.animations) {
                var e, i = {}, s = [], n = t.animations, r = 0, o = n.length;
                for (r = 0; r < o; r++) if (e = n[r]) {
                    var a = {};
        ...
        e._temParam = [], e._I = null, e._rootMatrix = null, s(e, [ "_tempMt", function() {
            ...
            i = function() {
                ...
                return t.prototype.recover = function() {
                    ...
                    this.resultTransform = null), q.recover("GraphicNode", this);
                }, t.create = function() {
        ...
        return e.prototype.createChildren = function() {
            Jt.regComponent("Text", Rt), laya.ui.Component.prototype.createChildren.call(this), 
        ...
        return s.destroy = function(e) {
            ...
            var t = this._vScrollBar && this._tf.maxScrollY > 0, e = this._hScrollBar && this._tf.maxScrollX > 0, i = t ? this._width - this._vScrollBar.width : this._width, s = e ? this._height - this._hScrollBar.height : this._height, n = this._tf.padding || W.labelPadding;
            ...
            i.superSet(ue, this, "width", t), this.callLater(this.changeScroll);
        }), r(0, s, "hScrollBar", function() {
            return this._hScrollBar;
        }), r(0, s, "height", t.prototype._$get_height, function(t) {
            i.superSet(ue, this, "height", t), this.callLater(this.changeScroll);
        }), r(0, s, "maxScrollX", function() {
            return this._tf.maxScrollX;
        }), r(0, s, "vScrollBarSkin", function() {
            return this._vScrollBar ? this._vScrollBar.skin : null;
        }, function(t) {
            null == this._vScrollBar && (this.addChild(this._vScrollBar = new ce()), this._vScrollBar.on("change", this, this.onVBarChanged), 
            this._vScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._vScrollBar.skin = t;
        }), r(0, s, "hScrollBarSkin", function() {
            return this._hScrollBar ? this._hScrollBar.skin : null;
        }, function(t) {
            null == this._hScrollBar && (this.addChild(this._hScrollBar = new he()), this._hScrollBar.on("change", this, this.onHBarChanged), 
        ...
        function e() {
            this.listData = null, this.pageIndex = 0, this.pageCount = 0, this.itemCount = 0, 
            e.__super.call(this), e.I = this, _t.I.addEvent("scoreList", this, this.onFriendScore), 
            i.stage.addChild(this), this.hideAll();
        }
        n(e, "PaiHang", fe);
        var s = e.prototype;
        return s.hideAll = function() {
            ...
            this.hideAll(), ct.show(this.rankList), "" != t ? _t.I.getGroupScore(t) : _t.I.getFriendScore();
        }, s.updateWjPaiHang = function(t) {
            this.hideAll(), ct.show(this.rankList), "" != t ? _t.I.getWjGroupScore(t) : _t.I.getWjFriendScore();
        }, s.onFriendScore = function() {
            this.pageCount = 0, this.pageIndex = 0, this.listData = _t.I.data;
            var t;
            this.itemCount = this.listData.length;
            for (var e = 0; e < this.itemCount; e++) {
                if ((t = this.listData[e]).openid == a.openid && -1 != a.scoreMax) switch (a.rankType) {
                  case 1:
                    t.score = a.scoreMax;
                    break;

                  case 2:
                    t.wjScore1 = a.wjScore;
                } else switch (a.rankType) {
                  case 1:
                    t.score = parseInt(t.KVDataList[0].value);
                    break;

                  case 2:
                    t.wjScore1 = t.KVDataList[0] ? parseInt(t.KVDataList[0].value) : 0;
                }
                t.nickname && (t.nickname = t.nickname.replace(/蜡烛/g, "**").replace(/坦克/g, "**").replace(/风筝/g, "**").replace(/火炬/g, "**").replace(/89/g, "**").replace(/64/g, "**").replace(/自由战斗/g, "**").replace(/自由交易/g, "**").replace(/自由/g, "**"));
            }
            switch (a.rankType) {
              case 1:
                this.listData.sort(this.sortByScore);
                break;

              case 2:
                this.listData.sort(this.sortByWjScore);
            }
            this.pageIndex = 0, this.pageCount = Math.ceil(this.itemCount / 5), this.updateList();
        }, s.nextPage = function() {
            ...
            this.pageCount > 0 ? this.tPage.text = this.pageIndex + 1 + "/" + this.pageCount : this.tPage.text = "0/0";
        }, s.fillFriend = function(t, e) {
            var i = this.rankList.getChildAt(t);
            if (-1 == e) i.visible = !1; else {
                i.visible = !0;
                var s = this.listData[e];
                switch (i.getChildByName("bg").skin = s.openid == a.openid ? "open/5.png" : "open/4.png", 
                e < 3 ? (i.getChildByName("iIndex").visible = !0, i.getChildByName("iIndex").skin = "open/" + (e + 1) + ".png", 
                i.getChildByName("tIndex").text = "") : (i.getChildByName("iIndex").visible = !1, 
                i.getChildByName("tIndex").text = "" + (e + 1)), i.getChildByName("iAvatar").skin = s.avatarUrl, 
                i.getChildByName("tName").text = s.nickname, a.rankType) {
                  case 1:
                    i.getChildByName("tLevel").text = s.score + "关";
                    break;

                  case 2:
                    i.getChildByName("tLevel").text = s.wjScore1 + "秒";
                }
            }
        }, s.sortByScore = function(t, e) {
            return t.score > e.score ? -1 : t.score < e.score ? 1 : 0;
        }, s.sortByWjScore = function(t, e) {
            return t.wjScore1 > e.wjScore1 ? -1 : t.wjScore1 < e.wjScore1 ? 1 : 0;
        }, e.I = null, e;
    }();
    i.__init([ h, ft, H, B, Jt, J, de, E ]), new a();
