...
CommDrawItem = Class.extern(function(){
	...
	this.drawPkgItem = function(item, ritem, forceShowNumber){
		_drawNumber(item,  _getNeedDrawNumber(ritem, forceShowNumber));
	...
	var _getNeedDrawNumber = function(ritem, forceShowNumber){
		if ( _isNeedDrawNumber(ritem, forceShowNumber) ) {
			return ritem.number;
		} else {
			return '';
		}
	...
	var _isNeedDrawNumber = function(ritem, forceShowNumber){
	...
	var _drawNumber = function(item, num){
