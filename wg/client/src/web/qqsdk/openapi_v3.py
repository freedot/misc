...
class OpenAPIV3(object):
    ...
    def call(self, url_path, params, method='post', protocol='http'):
        ...
        try:
            ...
            if data == None: # add by qjb
                return {'ret':OPEN_HTTP_TRANSLATE_ERROR, 'msg':'sys error!'}
...
def main():
    appid = 1101114844
    appkey = 'lZI37n3ccBkCbP5c'
    iplist = ('119.147.19.43',)

    openid = '6E8A4F26FDD627126B11E489DD1DDFDB'
    openkey = 'D89EF7CCC74485378505A74BD2B60864'
