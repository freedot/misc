...
g_vaildlistmap = {
	...
	'Dialog':['Type', 'Style', 'Position', 'ItemName', 'Width', 'Height', 'ZIndex', 'NormalClass', 'Modal', 'Dlgpos', 'Title', 'UIBack'],
...
g_attrmaps = {
	...
	'Modal':gridlib.GRID_VALUE_CHOICE + ':false,true',
	'Dlgpos':gridlib.GRID_VALUE_STRING,
	'Title':gridlib.GRID_VALUE_STRING
}
...
def GetAttrOutValue(key, param,parent):
	if key == 'Type':
		...
		if param == 'none' or param == '' or param == 'false':
			return 0
		if param == 'true':
			return 1
	return param
